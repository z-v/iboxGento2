...
--
-- Host: localhost:3306
-- Generation Time: Nov 13, 2015 at 03:23 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Adminnotification Inbox' AUTO_INCREMENT=321 ;
...
(53, 4, '2011-03-31 21:43:02', 'Magento CE 1.5.1.0-rc1 Now Available', 'We are happy to announce the availability of Magento Preview Version CE 1.5.1.0-rc1 for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1510-rc1-now-available/', 0, 1),
(54, 4, '2011-04-26 22:21:07', 'Magento CE 1.5.1.0-stable Now Available', 'We are excited to announce the availability of Magento CE Version 1.5.1.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1510-stable-now-available/', 0, 1),
(55, 4, '2011-05-26 22:33:23', 'Magento Preview Version CE 1.6.0.0-alpha1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.6.0.0-alpha1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1600-alpha1-now-available/', 0, 1),
(56, 4, '2011-06-15 21:12:08', 'Magento Preview Version CE 1.6.0.0-beta1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.6.0.0-beta1for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1600-beta1-now-available/', 0, 1),
(57, 4, '2011-06-30 22:03:58', 'Magento Preview Version CE 1.6.0.0-rc1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.6.0.0-rc1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1600-rc1-now-available/', 0, 1),
(58, 4, '2011-07-11 22:07:39', 'Magento Preview Version CE 1.6.0.0-rc2 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.6.0.0-rc2 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1600-rc2-now-available/', 0, 1),
(59, 4, '2011-08-19 20:58:31', 'Magento CE 1.6.0.0-stable Now Available', 'We are excited to announce the availability of Magento CE Version 1.6.0.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1600-stable-now-available/', 0, 1),
(60, 4, '2011-09-17 04:31:26', 'Magento Preview Version CE 1.6.1.0-beta1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.6.1.0-beta1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1610-beta1-now-available/', 0, 1),
(61, 4, '2011-09-29 18:44:10', 'Magento Preview Version CE 1.6.1.0-rc1 is now available', 'We are happy to announce the availability of Magento Preview Version CE 1.6.1.0-rc1 for download.\nAs this is a preview version it is NOT recommended in any way to be used in a production environment.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1610-rc1-now-available/', 0, 1),
(62, 4, '2011-10-19 20:50:05', 'Magento CE 1.6.1.0-stable Now Available', 'We are excited to announce the availability of Magento CE Version 1.6.1.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1610-stable-now-available/', 0, 1),
...
(83, 4, '2014-11-24 23:25:21', 'Magento Community Edition 1.9.1 is available!', 'Magento Community Edition 1.9.1 empowers merchants to deliver compelling shopping experiences by offering enhanced responsive design capabilities, new swatches to display product variations, and improved performance through support for MySQL 5.6 and PHP 5.5. It also includes support for Google Universal Analytics and over 70 product improvements. Find out more at http://magento.com/blog/magento-news/magento-community-edition-191-now-available-download', 'http://magento.com/blog/magento-news/magento-community-edition-191-now-available-download', 0, 1),
...
(85, 1, '2015-04-16 15:17:07', 'Critical Reminder: Download and install Magento security patches.  Download now.', 'Download and implement 2 important security patches (SUPEE-5344 and SUPEE-1533) from the Magento Community Edition download page (https://www.magentocommerce.com/products/downloads/magento/).  If you have not done so already, download and install 2 previously-released patches that prevent an attacker from remotely executing code on Magento software.  These issues affect all versions of Magento Community Edition.  A press release from Check Point Software Technologies in the coming days will make one of these issues widely known, possibly alerting hackers who may try to exploit it.  Ensure the patches are in place as a preventative measure before the issue is publicized.', 'https://www.magentocommerce.com/products/downloads/magento/ ', 0, 1),
(86, 1, '2015-04-19 21:37:00', 'Second Reminder: Download and install Magento critical security patches now.', 'If you have not done so already, download and install 2 previously-released security patches (SUPEE-5344 and SUPEE-1533) from the Magento Community Edition download page (https://www.magentocommerce.com/products/downloads/magento/).  These security issues affect all versions of Magento Community Edition and enable an attacker to remotely execute code on Magento software. A press release from Check Point Software Technologies tomorrow  will make one of these issues widely known, possibly alerting hackers who may try to exploit it.  Ensure the patches are in place as a preventative measure before the issue is publicized.', 'https://www.magentocommerce.com/products/downloads/magento/', 0, 1),
(87, 1, '2015-04-23 18:43:31', 'Urgent: Immediately install Magento critical security patches', 'It is critical for you to download and install 2 previously-released security patches (SUPEE-5344 and SUPEE-1533) from the Magento Community Edition download page (https://www.magentocommerce.com/products/downloads/magento/).  Please do this immediately, as Check Point Software Technologies has published a technical description of how they discovered the issue, which we feel might serve as a tutorial for implementing an attack against your website. ', 'https://www.magentocommerce.com/products/downloads/magento/', 0, 1),
(88, 1, '2015-05-14 23:34:01', 'Important: New Magento Security Patch - Install it Now', 'It is important for you to download and install a new security patch (SUPEE-5994) from the Magento Community Edition download page (https://www.magentocommerce.com/products/downloads/magento/).  Please apply this critical update immediately to help protect your site from exposure to multiple security vulnerabilities impacting all versions of the Magento Community Edition software. Please note that this patch should be installed in addition to the recent Shoplift patch (SUPEE-5344).', 'https://www.magentocommerce.com/products/downloads/magento/', 0, 1),
(89, 4, '2015-07-07 15:28:25', 'Now available:  Enhanced site quality and security with Community Edition 1.9.2', 'Magento Community Edition 1.9.2 is now available for download and features over 105 product improvements, nearly 170 automated functional tests to help internal development teams improve implementation quality and time to market, and several security enhancements. Read our blog announcement for more information (http://magento.com/blog/magento-news/magento-community-edition-192-now-available), or go to the Community Edition download page to get the software today (https://www.magentocommerce.com/products/downloads/magento/).', 'https://www.magentocommerce.com/products/downloads/magento/', 0, 1),
(90, 1, '2015-07-07 16:08:05', 'July 7, 2015: New Magento Security Patch (SUPEE-6285) – Install Immediately', 'Today we are providing a new security patch (SUPEE-6285) that addresses critical security vulnerabilities. The patch is available for Community Edition 1.4.1 to 1.9.1.1 and is part of the core code of our latest release, Community Edition 1.9.2, available for download today.  PLEASE NOTE:  You must first implement SUPEE-5994 to ensure SUPEE-6285 works properly. Download Community Edition 1.9.2 or the patch from the Community Edition download page: https://www.magentocommerce.com/products/downloads/magento/  ', 'https://www.magentocommerce.com/products/downloads/magento/', 0, 1),
(91, 1, '2015-08-04 16:28:26', 'August 4, 2015: New Magento Security Patch (SUPEE-6482) – Install Immediately', 'Today we are providing a new security patch (SUPEE-6482) that addresses 4 security issues; two issues related to APIs and two cross-site scripting risks. The patch is available for Community Edition 1.4 and later releases and is part of the core code of Community Edition 1.9.2.1, which is available for download today. Before implementing this new security patch, you must first implement all previous security patches. Download Community Edition 1.9.2.1 or the patch from the Community Edition download page at https://www.magentocommerce.com/products/downloads/magento/  ', 'https://www.magentocommerce.com/products/downloads/magento/  ', 0, 1),
(92, 2, '2015-08-05 19:12:55', 'August 5, 2015:  Security Patch (SUPEE-6482) Release Note CORRECTION', 'When we announced a new security patch (SUPEE-6482) for Community Edition yesterday we incorrectly said that it addresses 4 issues. It actually addresses 2 security issues: Autoloaded File Inclusion in Magento SOAP API and a SSRF Vulnerability in WSDL File. The patch and Community Edition 1.9.2.1 are complete, fully-tested, and ready to deploy. We strongly encourage you to deploy the patch or upgrade to the latest version of Community Edition if you haven’t done so already. You can find the patch at https://www.magentocommerce.com/products/downloads/magento/. ', 'https://www.magentocommerce.com/products/downloads/magento/', 0, 1),
(93, 4, '2015-10-01 16:32:53', 'Episode VI: Return of Imagine Commerce | 2016 Registration is Open!', 'The force is strong with this one. Join the Magento rebellion at Imagine Commerce 2016. Enlist Now at http://imagine.magento.com.', 'http://imagine.magento.com', 0, 1),
(94, 1, '2015-10-20 23:28:05', 'New Malware Issue. Make Sure You Have Implemented All Security Patches', 'We have received reports that some Magento sites are being targeted by Guruincsite malware (Neutrino exploit kit). We have NOT identified a new attack vector at this time. Nearly all the impacted sites checked so far were vulnerable to a previously identified and patched issue; sites not vulnerable to that issue show other unpatched issues. Visit the Magento Security Center at http://magento.com/security/news/important-security-update for more information on how to address this issue and make sure that you have implemented all recent security patches.\n', 'http://magento.com/security/news/important-security-update', 0, 1),
(95, 1, '2015-10-27 21:48:23', 'October 27, 2015: New Magento Security Patch (SUPEE-6788) – Install Immediately', 'Today, we are releasing a new patch (SUPEE-6788) and Community Edition 1.9.2.2 to address 10+ security issues, including remote code execution and information leak vulnerabilities. This patch is unrelated to the Guruincsite malware issue. Be sure to test the patch in a development environment first, as it can affect extensions and customizations. Download the patch from the Community Edition Download page and learn more at http://magento.com/security/patches/supee-6788  ', 'http://magento.com/security/patches/supee-6788  ', 0, 1),
(96, 4, '2011-08-22 05:45:25', 'Magento Absolute theme is available for Magento Go now! ', 'Magento Absolute theme is available for Magento Go now! ', 'http://templates-master.com/magento-templates/free-absolute-magento-go-template.html', 0, 1),
(97, 4, '2011-09-06 05:27:48', 'New Elastic Premium template for Magento is published', 'New Elastic Premium template for Magento is published.', 'http://bit.ly/pf0ilp ', 0, 1),
(98, 3, '2011-09-12 00:37:58', 'Magento 1.6 compatability update', 'All our themes and extensions compatible with Magento 1.6 CE now!  Request your update at http://bit.ly/q51qxj ', 'http://bit.ly/q51qxj ', 0, 1),
(99, 4, '2011-09-19 04:52:59', 'Check our new Affiliate Suite extension for Magento CE', 'Affiliate Suite by Templates Master will help you to build new efficient sales channe. Your new affiliate partners will be able to promote your store by emailing, placing links, banners and other  media on their sites and any social networks profiles.', 'http://bit.ly/oKa0zd ', 0, 1),
(100, 4, '2011-10-12 06:02:30', 'Magento Easybanners 1.1 is now available', 'Easybanners provide easy and powerful tools to manage and target banners to specific users. We are proud to announce that this extension provide support for Magento widgets now. So you can place any banner or placeholder right into your cms page. We have also added option to call out placeholders directly in the phtml templates.', 'http://bit.ly/phgpx5', 0, 1),
(101, 4, '2011-11-04 09:49:59', 'Join us on Facebook and get one time 10% OFF on all our templates and extensions.', 'Join us on Facebook and get one time 10% OFF on all our templates and extensions.', 'http://on.fb.me/rYE7qW ', 0, 1),
(102, 4, '2011-11-08 08:00:10', 'Affiliate Suite 1.0.5  is now available', 'Affiliate Suite by Templates Master will help you to build new efficient sales channel and start offering affiliate programs at your store.\n\nNew features\n- Allow to copy banners\n- Autoselect default campaign on partner registration\n- Ordered products report interface added\n\nBug fixes\n- Prowidget tool hidden on frontend if disableded', 'http://bit.ly/saXDyk', 0, 1),
(103, 4, '2011-11-11 07:40:50', 'Firecheckout 1.6.1 compatability update ', 'Firecheckout is now fully compatible with Magento 1.6.1', 'http://bit.ly/sUDhHK ', 0, 1),
(104, 4, '2011-11-17 08:28:50', 'New Product Highlight extension for Magento is now available!', 'New Product Highlight extension for Magento is now available!', 'http://bit.ly/tGwtwZ ', 0, 1),
(105, 4, '2011-11-22 09:04:45', 'Magento Easy Slider is now available as standalone extension!', 'Magento Easy Slider is now available as standalone extension!', 'http://bit.ly/uu0GxJ ', 0, 1),
(106, 4, '2011-11-28 07:45:49', 'Cyber Monday Discount! Get 20% off for all our products - code THNK20 ', 'Cyber Monday Discount! Get 20% off for all our products - code THNK20 ', 'http://bit.ly/sBBbSa', 0, 1),
(107, 4, '2011-11-30 07:22:50', 'Helpmate 1.1 is now available', 'Helpmate 1.1 is now available\n\nFeatures:\n- 2 types of contact form. First is default and second one is like http://www.payoneer.com/contactUs.aspx \n- Attach allowed files from emails\n- Akismet integration\n\nBug fix\n- File upload bug in admin fixed', 'http://bit.ly/teCtnm ', 0, 1),
(108, 4, '2011-12-13 05:44:45', 'Magento 1.6.1 compatability update', 'We are glad to inform that recent themes 1.6.1 update also include recent version of Highlight and Easyslide extension.\nRequest your update at http://bit.ly/q51qxj ', 'http://bit.ly/sEHONg ', 0, 1),
(109, 4, '2011-12-21 08:14:11', 'Social Suit extension for Magento is now available!', 'Social Suit - New Facebook & Google social networks integration extension for Magento', 'http://bit.ly/ugYisg ', 0, 1),
(110, 4, '2012-01-12 05:50:11', 'Firecheckout 2.0 is now available.', 'Firecheckout 2.0  is now available with great new features:\n\n- Configurable address form fields sort order\n- Delivery date option\n- Flexible AJAX updates for checkout page\n- Improved overall performance over 30%\n- Now  available in 11 languages (English, Arabic, Chinese Simplified, Dutch, French, German, Italian, Japanese, Korean, Portuguese, Russian, Spanish, Swedish)', 'bit.ly/sUDhHK', 0, 1),
(111, 4, '2012-01-19 08:39:44', 'Magento Affiliate Suite 1.1 and Ajax Pro 1.6.6 are now available.', 'Magento Affiliate Suite 1.1 and Ajax Pro 1.6.6 are now available.', 'http://bit.ly/ycr6uq ', 0, 1),
(112, 4, '2012-01-30 07:10:21', 'Magento Affiliate Suite 1.1.1 is now available', 'Please update your Affialite suite to recent 1.1.1 version.', 'bit.ly/saXDyk', 0, 1),
(113, 4, '2012-02-02 07:26:01', 'Social Suite 1.1 with great new features is now available', '- Twitter integration\n- Allow to login with social networks on checkout page\n- Firecheckout login integration support\n- Floating social panel\n- Improved localization\n', 'http://bit.ly/A8h4yk', 0, 1),
(114, 4, '2012-02-15 06:44:58', 'Lightbox Pro extension for Magento is now available!', 'Lightbox Pro will replace default magento image zoom with new easy-to-use and flexible Lightbox widget. ', 'http://bit.ly/xmm1WU', 0, 1),
(115, 4, '2012-03-12 09:11:39', 'Mobile Star - Android and iPhone theme for Magento is now available!', 'Don’t loose your chance to keep contact with your customers while they are using their phones. We have created Mobile Star Magento theme that will help you join new e-commerce revolution and build your mobile presence just in 5 minutes. Mobile Star is specially designed Magento theme that will work on iPhone, Android  and any other advanced phone. ', 'http://bit.ly/z5XF3M ', 0, 1),
(116, 4, '2012-03-20 06:48:13', 'Mobile Star template for iPhone and Android is compatible with Magento CE 1.4 —1.6 now.', 'Don’t loose your chance to keep contact with your customers while they are using their phones. We have created Mobile Star Magento theme that will help you join new e-commerce revolution and build your mobile presence just in 5 minutes. Mobile Star is specially designed Magento theme that will work on iPhone, Android  and any other advanced phone. ', 'http://bit.ly/GBPp2w', 0, 1),
(117, 4, '2012-04-11 01:44:13', 'Firecheckout 2.1 is now available.', 'Firecheckout 2.1 is now available with great new features:\n\n- Editable shopping cart on checkout page\n- Optionally show products images on checkout page\n- Improved message for the customers using emails that are already in use\n- Improved Fire Checkout page layout\n- Improved performance while saving Fire Checkout configuration', 'http://bit.ly/IqPRSb ', 0, 1),
(118, 4, '2012-04-27 02:36:31', 'Fire Checkout 2.1.1 for Magento CE 1.7 is now available', 'Fire Checkout 2.1.1 for Magento CE 1.7 is now available', 'http://bit.ly/Igy452 ', 0, 1),
(119, 4, '2012-05-04 03:11:25', 'Mobile Star template is now compatible with Magento CE 1.7.0 and 1.4.0', 'Mobile Star template is now compatible with Magento CE 1.7.0 and 1.4.0', 'http://bit.ly/JXXWT4', 0, 1),
(120, 4, '2012-05-10 07:16:19', 'Absolute and classic themes are now compatible with Magento CE 1.7.0', 'Absolute and classic themes are now compatible with Magento CE 1.7.0', 'http://bit.ly/Jk7p4F ', 0, 1),
(121, 4, '2012-05-15 06:05:03', 'Firecheckout is now compatible with Magento Enterprise edition.', 'Firecheckout is now compatible with Magento Enterprise edition.', 'http://bit.ly/JQqvRi ', 0, 1),
(122, 4, '2012-05-24 11:39:46', 'Prolabels 2.0 with unlimited labels support now available!', 'Prolabels 2.0 is now available with great new features:\n\n- Unlimited number of labels\n- Flexible condition rules\n- Optimized for large catalogs', 'http://bit.ly/MKP9ou ', 0, 1),
(123, 4, '2012-05-25 06:40:31', 'Helpmate with great new features and Magento CE 1.7 support is now available', ' Helpmate 1.2 is now available with great new features:\n\n- Private tickets responses not visible to users.\n- Create ticket buttons on order and customer admin pages\n- Multiply select option for storeviews on kb articles page\n- Categories and Articles sort order in KB\n- Improve search and suggest algorithm of KB articles\n- Ajax Search compatibility ', 'http://bit.ly/LhSTwf ', 0, 1),
(124, 4, '2012-05-30 08:07:16', 'Magento templates are now compatible with Magento CE 1.7', 'We are glad to inform that all our templates were recently updated to Magento CE 1.7. Request your update at http://bit.ly/q51qxj ', 'http://bit.ly/KHFrQY', 0, 1),
(125, 4, '2012-06-22 06:22:54', 'Prolabels 2.1 is now available', 'Prolabels 2.1 is now available with next new features and bugfixes:\n\n- Performance update\n- Active products grid interface added for labels\n- Out of stock label text option added\n- Catalog indexes conflict fixed', 'http://bit.ly/LGESFz', 0, 1),
(126, 4, '2012-07-05 06:12:33', 'Firecheckout 2.2 is now available.', 'Fire Checkout 2.2 is now available with great new features:\n\n- 5 custom order fields added\n- Hide other shipping methods, if free is applicable (optional)\n- Nice looking styles on our Mobile Star theme\n- Improved positioning of the popup window and spinner on mobile devices\n- Fixed conflict with Magento''s _canShowForUnregisteredUsers method.\n- In order to improve Fire Checkout compatibility with third party extensions "Enable Agreements" option was removed. Please use Magento standard config option instead. You can find it at the checkout options section.', 'http://bit.ly/N8Cyqi', 0, 1);
INSERT INTO `adminnotification_inbox` (`notification_id`, `severity`, `date_added`, `title`, `description`, `url`, `is_read`, `is_remove`) VALUES
(127, 4, '2012-07-25 06:07:32', 'Prolabels 2.2 is now available', 'Prolabels 2.2 is now available with next new features\n\n- Unlimited number of system labels\n- Improved localization for system labels\n', 'http://bit.ly/Qj65pj', 0, 1),
(128, 4, '2012-08-01 07:26:13', 'Ajax Layered Navigation 1.1 is now available', 'Ajax Layered Navigation 1.1 is now available with next new features\n\n- Two new layered navigation styles: vertical layered navigation and drop down layered navigation\n- Limit number of filters to show\n- Improved Magento 1.7 compatibility\n- Improved price ranges algorithm\n', 'http://bit.ly/ODpjUN', 0, 1),
(129, 4, '2012-08-09 06:31:48', 'Ajax Pro 2.0  is now available', 'Ajax Pro 2.0  is now available with next new features\n\n- completely refactored extension logic for better performance and better compatibility\n- javascript login form added', 'http://bit.ly/Na3k8u', 0, 1),
(130, 4, '2012-08-17 07:17:07', 'Social Suite 1.2 with Pinterest integration is now available', 'Social Suite 1.2  is now available with next new features\n\n- Pinterest integration\n', 'http://bit.ly/N8Mcu0', 0, 1),
(131, 4, '2012-08-27 06:15:31', 'Ajax Pro 2.0.1 update is now available', 'Ajax Pro 2.0.1  is now available with next new features\n\n- Ajax Pro links and actions disabled for search engines spiders\n', 'http://bit.ly/PVixZE', 0, 1),
(132, 4, '2012-08-30 11:16:37', 'Helpmate 1.2.1 is now available', 'Helpmate 1.2.1  is now available with next new features\n\n- Captcha support for Magento 1.7\n- Frontend layout field label alignment fixed\n- File uploaded type javascript validation added\n- Order info field is now optional\n- Improved admin tickets message format\n\n', 'http://bit.ly/UdSddX', 0, 1),
(133, 4, '2012-09-17 01:56:48', 'Fire Checkout 2.3.1 is now available. Check more details on most advanced  one page checkout for Magento.', 'Fire Checkout 2.3.1 is now available with next new features\n\n- Added check for minimum order amount during cart update\n- Fire Checkout layout updated. Now it has more cleaner place order section.\n- Order review block added for EU countries and overall layout is now fully compatible with recent EU requirements\n- Shopping cart section improved. Product name as link and short products description cab be shown now\n\n', 'http://bit.ly/Prk3Bp', 0, 1),
(134, 4, '2012-09-18 06:26:11', 'Facebook Like Button 2.0 is now available', 'Facebook Like Button 2.0 is now available with next new features\n\n- Allow to place like buttons on categories pages\n- Flexible locale configuration in admin\n- Fixed problems with meta image and description information\n', 'http://bit.ly/QiEL5P', 0, 1),
(135, 4, '2012-09-27 06:05:58', 'Buy 2 products and get 5% OFF on entire order ', 'We are really glad to offer new discount for our clients: Buy 2 products and get 5% OFF on entire order. No coupon code needed.', 'http://bit.ly/OXhGd3', 0, 1),
(136, 4, '2012-10-04 01:56:32', 'Navigation Pro - most powerful Magento navigation solution is now available! ', NULL, 'http://bit.ly/QHQC04', 0, 1),
(137, 4, '2012-10-09 05:08:56', 'Mobile Star Magento theme  version 1.2 is available. Now with mobile theme switcher.', NULL, 'http://bit.ly/VVrZPt', 0, 1),
(138, 4, '2012-10-11 01:38:08', 'Navigation Pro is now compatible with Magento Community 1.4+ and Magento Enterprise 1.12+ ', NULL, 'http://bit.ly/T7Qe8w', 0, 1),
(139, 4, '2012-10-15 06:54:50', 'Firecheckout 2.3.2 is now available ', 'Fire Checkout 2.3.2 is now available with next new features\n\n- Saving delivery date and additional checkout fields when PaypalExpress or similar method is used fixed.\n- Payone integration added\n', 'http://bit.ly/Rx95xd', 0, 1),
(140, 4, '2012-10-18 07:46:49', 'Easy Slider 2.0 with Nivo slider integration is now available', 'Easy Slider 2.0 is now available with next new features\n\n- Nivo slider integration\n- Support 18 Nivo slider effects\n- Responsive design friendly\n- Load jQuery in no-conflict mode', 'http://bit.ly/R2MW7e', 0, 1),
(141, 4, '2012-10-24 07:30:25', 'Ajax Pro user manual and  demo is now updated to recent 2.0 version', NULL, 'http://bit.ly/Siqs4g ', 0, 1),
(142, 4, '2012-10-31 09:14:53', 'Helpmate 1.3.0 is now available', 'Helpmate 1.3.0  is now available with next new features\n- Allow admins to answer tickets via email gateway\n- WYSIWYG editor is now available in admin ticket interface\n- Optionally display html tags in tickets interface\n\nFixes\n- Fixed issue with error message attached to tickets for disallowed file types\n- Improved email format auto-detect feature\n', 'http://bit.ly/PHeEdJ', 0, 1),
(143, 4, '2012-11-02 09:21:07', ' Increase click-through rates on search engines results pages with Google Rich Snippets extension for Magento', NULL, 'http://bit.ly/SBLpqY', 0, 1),
(144, 4, '2012-11-08 02:59:06', 'Google Rich Snippet 1.1 is now available', 'Google Rich Snippet  1.1.0  is now available with next new features\n\n- Each snippet can be disabled or enabled now in extension configuration \n- Manufactures snippet configuration field converted to dropdown\n- Seller snippet configuration field converted to text area\n- Improved compatibility with magento 1.4\n', 'http://bit.ly/RGZsMi', 0, 1),
(145, 4, '2012-11-20 05:48:20', 'Firecheckout 2.3.3 is now available', 'Fire Checkout 2.3.3 is now available with next new features\n\n- Unirgy gift card integration fixed.\n- Order review with single payment method fixed.\n- Order review with billing address only fixed.\n- Buyerprotection integration added.\n', 'http://bit.ly/10lYxU0 ', 0, 1),
(146, 4, '2012-11-22 06:25:47', 'Magento Easy Catalog Images 2.0 is now available', 'Easy Catalog Images 2.0  is now available with next new features\n\nGeneral:\n-  Perfomance improvements. Dramatically decreased query count per block render (One query).\n-  Cache support added.\n-  Flexible grid styles added to support multicolumn mode for various site styles without modifying the styles. 2-6 columns are supported out of the box.\n-  Category thumbnail is displayed instead of category image by default.\n-  Widget support added. Widget is fully configurable with custom options. You can insert the Easy Catalog Images where you wish to. (Any cms page, block etc)\n-  EasyCatalogImages block is now shown above the category title. We did this to prevent numerous conflicts with custom themes.\nConfiguration improvements:\n-  Maximum category count to show added.\n-  Ability to set the background color for resized image. White by default.\n\nRemoved features. (Removed to improve compatibility with custom themes)\n-  ''Show categories listing'' on homepage removed. Please use the homepage editor and add Easy Catalog Images widget directly to the homepage content.\n-  Alibity to disable product listing removed. Please use the built-in Magento option on category edit page.\n-  ''Show child categories'' field removed. Please use the ''Number of subcategories to show'' field get the same result.\n\n', 'http://bit.ly/SX6qdg', 0, 1),
(147, 4, '2012-11-26 03:20:02', 'Cyber Monday Discount! Get 15% off for all our products - code CYBER15', 'Cyber Monday Discount! Get 15% off for all our products - code CYBER15', 'http://bit.ly/TdT2ld', 0, 1),
(148, 4, '2012-11-28 08:30:29', 'Improve your customers shopping experience with Ajax Pro 2.1 ', 'Ajax Pro 2.1 is now available with next new features:\n\n- Improved IE compatibility\n- Bug with limited wishlist products number fixed\n- Problem with compare list clear feature resolved\n- Problem with continue shopping button for configurable products resolved\n- Completely removed ajaxpro actions from compare popup for better user experience', 'http://bit.ly/10Wm13j', 0, 1),
(149, 4, '2012-11-29 09:27:32', 'Amend layered navigation with  Ajax Layered Navigation 1.2', 'Ajax Layered Navigation 1.2 is now available with next new features:\n\n- Search form added\n- Scroll effect added for better user experience\n- Fixed problem with price slider for non-valid intervals\n- Fixed problems with selected category filter\n- Improved IE compatibility\n', 'http://bit.ly/11jZDzU', 0, 1),
(150, 4, '2012-12-05 02:45:01', 'Create custom products blocks with Products Highlight 2.3 ', 'Products Highlight 2.3  is now available with next new features:\n\n-Hightlight page with product listing added.\n-Product type filter added\n-SEO urls support added to the homepage highlight listing.', 'http://bit.ly/VvIx2B', 0, 1),
(151, 4, '2012-12-06 01:31:23', 'Improve your store sales with Fire Checkout 2.3.4', 'Fire Checkout 2.3.4 is now available with next new features:\n\n- Agreements wrapper will not visible, if there are no agreements available.\n- OrderReview styles improvements.\n- IE stability fix for slowly loading sites.\n- Payment tooltip positioning fixed, when position relative is used on parent elements.\n- IE7 css and javascript fixes.\n- CheckoutFields updated:\n- Compatibility with Magento 1.5, 1.6 added.\n- Ability to enable/disable printing of checkout fields for invoices and packingslips', 'http://bit.ly/TE5kUj', 0, 1),
(152, 4, '2012-12-11 09:39:43', ' Google Rich Snippets 1.2.1 is now available ', 'Google Rich Snippets 1.2.1 is now available with next new features:\n\n- Description snippet is moved from meta tag to visible tag\n- Name snippet is moved from meta tag to visible tag\n- Review snippet is moved from meta tag to visible tag\n', 'http://bit.ly/125EfzM', 0, 1),
(153, 4, '2012-12-18 05:05:18', 'Protect your store back-end from unauthorized access with two-step verification by Google Authenticator', NULL, 'http://bit.ly/UOfT8z', 0, 1),
(154, 4, '2012-12-26 03:17:47', 'Enjoy the spirit of the season and get great savings at Templates Master. Get 20% off for all our products - code XMAS20', 'Enjoy the spirit of the season and get great savings at Templates Master. Get 20% off for all our products - code XMAS20', 'http://bit.ly/Vxx7VX', 0, 1),
(155, 4, '2013-01-04 07:37:04', ' Google Rich Snippets 1.2.4 is now available ', 'Google Rich Snippets 1.2.4 is now available with next new features:\n\n- Added organisation snippet\n- Review snippet template modified\n\n', 'http://bit.ly/X66lHs', 0, 1),
(156, 4, '2013-01-10 07:57:20', 'Ajax Search And Autocomplete 1.3.0 is now available ', 'Ajax Search And Autocomplete 1.3.0  is now available with next new features:\n\n- Fixed detection of element width and height\n- Fixed loader positioning, when relative styles are not used in theme\n- Optional filtering of suggestions by category added\n\n', 'http://bit.ly/WEem3w', 0, 1),
(157, 4, '2013-01-24 07:40:19', 'Improve your checkout experience with Fire Checkout 2.3.6', 'Fire Checkout 2.3.6 is now available with next new features:\n\n- Paypal fixes for payflowlink, payflowadvanced and hostedpro solutions\n- Fixed missing dicount amount, when placing order as guest in Magento 1.7.0.2\n- TBT RewardsPoint partial integration\n- Improved display of long product attributes in shopping cart\n- SVMPayment integration fixed\n- Improved integration with SagepayDirect incheckout mode\n- CraftyClicks integration improvements', 'http://bit.ly/V9ArYB', 0, 1),
(158, 4, '2013-02-11 09:01:41', 'Get 14% OFF with St. Valentine''s special offer', 'Valentine''s Day is quickly approaching and we are glad to offer special discount for all our beloved customers. It''s a great chance to get any our extensions or template with 14% discount.  Our Valentine''s offer ends on February 15 so don''t miss your chance to improve your store!', 'http://bit.ly/Y6AhmA', 0, 1),
(159, 4, '2013-02-25 00:20:54', 'Meet Argento - Most powerful Magento responsive theme ', 'Argento is more than just another template created for Magento. It was created right from the ground based on the best ecommerce stores practices and according to Magento developers guidelines. Powered with more than 15 popular Magento extensions and based on HTML5 and CSS3 it will bring your store to absolutely new level. Argento was optimized both for speed and SEO, tested in popular browsers and different mobile devices in order to increase conversion and improve shopping experience.', 'http://bit.ly/XVMvNk', 0, 1),
(160, 4, '2013-03-01 07:57:38', 'Improve your store support process with Helpmate 1.4', 'Finished:\n-  Separate quick answer element was added\n-  Pagination toolbar added for frontend users ticket interface\n-  Admin users can now use hidden departments in order to escalate issues to this department\n-  Helpdesk priority page design improved\n-  Grid interfaces added for related products articles interface at products admin interface\n-  FAQ drop-down can be used now to insert either link or complete KB article \n-  Related articles block on product page moved to content area\n-  Improved html template structure for compatibility with custom design\n\nFixes\n- Editor freeze after using quick answer\n- HTML tags were used when posting KB articles as quick answer form\n- Localisation improved', 'http://bit.ly/YEbEw0', 0, 1),
(161, 4, '2013-03-06 09:13:31', 'Easy Colors Swatches 1.3 with new great features is now available  ', 'Features:\n\n-  separate admin interface\n-  show selected image in cart block for configurable products\n-  allow to create swatches without assigned images\n-  improved javascript code\n', 'http://bit.ly/YcSj5l', 0, 1),
(162, 4, '2013-03-14 07:29:25', 'Improve your store conversion rate with Fire Checkout 2.4', 'Fire Checkout 2.4.0 is now available with next new features:\n\n- Css and templates moved to base folder in order to provide compatibility with non-default based themes\n- Css improvements. Form fields are now have fluid styles, to match various theme width\n- Customer comments moved to separate database field\n- Added ability to edit customer comment, delivery date and additional fields from backend interface\n- Improved configuration section for form fields sort order. Drag''n''drop is now supported\n- Optional Usps address verification added. Only United States addresses will be verified if enabled\n- Improved edit address links at the address review section \n- Integration with Storepickup module updated\n- AheadWorks Point extensionintegration added\n- Added support of SagePay saved tokens feature\n- Paymill integration added\n- Generel code cleanup\n- Syntax errors removed', 'http://bit.ly/WfgLrb', 0, 1),
(163, 4, '2013-03-25 08:13:00', 'Reward your customers for sharing news about your store with Social Suite 1.3 ', 'Social Suite 1.3  is now available with next new features:\n\n- Reward your customers for sharing news about your store\n- Asynchronous javascript load for social buttons for better page performance\n- Facebook login and google login feature updated for better user experience\n', ' http://bit.ly/YauZK9', 0, 1),
(164, 4, '2013-03-29 06:34:11', 'Save 20% on all themes and extensions with our Easter sale!', 'Save 20% on all themes and extensions with our Easter sale!', 'http://bit.ly/172I9fh', 0, 1),
(165, 4, '2013-04-02 07:38:44', 'Get Mobile star template with improved Retina screen support', 'Get Mobile star template with improved Retina screen support', 'http://bit.ly/XGcgqk', 0, 1),
(166, 4, '2013-04-08 07:26:03', 'Improve your layered navigation with Ajax Layered Navigation 1.2.2 ', 'Improve your layered navigation with Ajax Layered Navigation 1.2.2 ', 'http://bit.ly/Zd5gxb', 0, 1),
(167, 4, '2013-04-11 07:57:51', 'Attract your customers attention with Prolabels 1.2.2', NULL, 'http://bit.ly/12MmKaK', 0, 1),
(168, 4, '2013-04-17 02:10:46', 'Fire Checkout 2.4.1 is now available ', 'Fire Checkout 2.4.0 is now available with next new features:\n\n- MageWorx Customercredit integration\n- Css improvements for mobile and tablet devices\n- First available shipping will not selected if default one is not found\n- Fixed shipping price, when weight vs destination is used. Matrix rate compatibility added.\n- Kiala LocateAndSelect integration added\n- BillPay compatibility\n- Comptibility with Magento per-country postcode and region configuration added', 'http://bit.ly/YTOUyh', 0, 1),
(169, 4, '2013-04-23 07:21:53', 'Manage your store banners with Easy Banners 1.3.0 ', 'Easy Banners 1.3.0  is now available with next new features:\n\n- Ability to set image size added\n- Optional retina support added\n- Ability to use banner url for html mode added. Use the {{tm_banner_url}} variable in banner content.\n- Backend banner management interface improvements\n- Image dimensions added to html markup, when resizer is used\n', 'http://bit.ly/15EcDW5', 0, 1),
(170, 4, '2013-04-24 06:41:53', 'Argento responsive theme 1.1.2 is now available', ' Argento update\n\n*    Html markup and css improvements. YSlow - 86 PageSpeed - 93\n*    Review url fixed on product page\n*    Lightboxpro config options updated to look good on mobile screens\n*    Related products styles and image size improvements for small screen devices\n*    All small images styles improved for mobile devices\n*    Improved form styles\n*    Fixed product listing on advanced search results\n*    Facebook Like Button added\n*    Scroll to top button added\n\nSoldtogether updated\n\n*    Table prefix added to query\n*    Amazon styled template will show only simple products\n*    Fixed price calculation for bundle, configurable and grouped products when using amazon template\n*    Colection queries improvements\n\nEasyslide updated\n\n*    jQuery will not be added if nivo slider is not used\n*    Default slider options added when creating new slider\n*    Enabled option removed. Please use status option for each slider instance.\n*    Load jQuery option now affects on adding jQuery library only: nivo javascript will be added if nivo slider is used.\n\nEasycatalogimg updated\n\n*    Optional retina support added\n*    Image dimensions added to html markup\n\nEasybanner updated\n\n*    Ability to set image size added\n*    Optional retina support added\n*    Ability to use banner url for html mode added. Use the {{tm_banner_url}} variable in banner content.\n*    Backend banner management interface improvements\n*    Image dimensions added to html markup, when resizer is used\n', 'http://bit.ly/XWJ7pO', 0, 1),
(171, 4, '2013-04-27 20:48:07', 'Improve your newsletter marketing  performance with Newsletter Booster', NULL, 'http://bit.ly/ZLmOpn', 0, 1),
(172, 4, '2013-05-10 07:06:19', 'Improve your conversion rate with Fire Checkout 2.4.2', 'Fire Checkout 2.4.2 is now available with next new features:\n\n- Enterprise version compatibility update\n- New registration mode: Guest checkout is allowed and registration checkbox is checked by default\n- Ability to set the default checkbox state for shipping address and newsletter subscription\n- Configuration options grouped into smaller parts', 'http://bit.ly/Yz1eT6', 0, 1),
(173, 4, '2013-05-14 02:07:57', 'Ajax search security update 1.3.1', '- Security update. There was no security threat but bug can be considered as potential threat. ', 'http://bit.ly/19mHSSF', 0, 1),
(174, 4, '2013-05-20 05:58:09', 'Argento 1.2 with new Pure design is now available', 'Argento update:\n\n*    New Pure theme added\n*    Css styles optimization\n*    Css styles improvements for small tablet devices\n*    Removed php warnings during Argento installation\n*    Fixed upsell products decoration with first/last classes\n*    AjaxSearch updated - Security bugfix\n*    Easyslide updated - Nivo slider updated\n*    Askit updated - Grammar errors fixed\n*    Easybanner updated - Title field should not be required, when using html mode\n*    Facebook Like Button updated - Fixed access to facebook like button config section when internet connection is not available\n*    Highlight updated - Added translation of the highlight page title\n*    Soldtogether updated - Fixed bug, when no product is available, but soldtogether block is called', 'http://bit.ly/114IWeX', 0, 1),
(175, 4, '2013-05-28 05:43:12', 'Improve your shopping experience with Quick Shopping 1.2.0', 'Quick Shopping 1.2.0  is now available with next new features:\n\n- Templates and skin resources moved to base folder\n- Better compatibility with third-party themes\n- Highlight page support added\n- Updated styles for window and button\n- Layout xml optimization\n- Better javascript handling of response text\n- Amlanding integration added\n- QuickView button will be hidden if no css and js are loaded.', 'http://bit.ly/10Eoz3x', 0, 1),
(176, 4, '2013-06-04 06:42:38', 'Fire Checkout 2.4.3 is now available ', 'Fire Checkout 2.4.3 is now available with next new features:\n\n- Check for minimum amount when removing item from cart fixed.\n- No more unnecessary captcha refreshes, when updating page content.\n- Fixed optional and hidden region field for Magento 1.6.2 and earlier\n- Fixed hidden postcode field\n- Fixed bug when Mage_Persitent was disabled with etc/modules file\n- Improved compatibility with third-party themes, that used height style for input fields\n- Added parsing of System is busy message from VIES validator\n- AheadWorks Newsletter module integration added\n- Integration with Irvine DeliveryDate and JapanPost added\n- Partial uSplitRates integration added. Still needs to edit app/code/local/TM/FireCheckout/Model/Quote/Address.php\n- Partial integration with Stripe payment methods added. Need to edit stripe/form/stripe.phtml', 'http://bit.ly/11itvv9', 0, 1),
(177, 4, '2013-06-19 07:08:43', 'Allow your customers to create user generated content with Askit 2.0 ', 'Askit 2.0  is now available with next new features:\n\n Features\n- Allow to place discussion block on cms and categories pages\n- Added page with all products discussion at your store\n- Added products question search on all products page\n- Widget for recent discussion was added\n- Added folded or unfolded default states for products discussion\n\nFixes\n- Added notifications for additional responses by other visitors.\n', 'http://bit.ly/11ZuXG2', 0, 1),
(178, 4, '2013-07-02 06:40:16', 'Improve your store navigation with Layered Navigation 2.0', 'Layered Navigation 2.0 is now available with next new features:\n\n- SEO links for layered navigation\n- Optional non-follow element\n- Performance update - works 80% faster!\n- Optionally show search form if there is larger then x number of attributes\n- New layered navigation styles added', 'http://bit.ly/17R8pfW', 0, 1),
(179, 4, '2013-07-04 06:59:59', 'Save 20% on all themes and extensions with our Independence day sale! ', 'Save 20% on all themes and extensions with our Independence day sale! ', 'http://bit.ly/13v8dAa', 0, 1),
(180, 4, '2013-07-08 04:34:18', 'Increase your store sales with Firecheckout 2.4.4', 'Fire Checkout 2.4.3 is now available with next new features:\n\n- One firecheckout version for Magento 1.4.2.0-1.7.0.2\n- Irvine shipping methods integration added\n- Undefined warning removed, when using one line for address field\n- Compatibility with third party themes, that using border-box style for all elements\n- Customer credit integration fixed\n- Billsafe Integration\n- Euvat extension compatibility added\n- Ability to reload order totals on taxvat change added\n- Fixed displaying of Email already in use window\n- Password will not be copied to OrderReview section\n- Fixed ugiftcert warning when applying coupon code\n- Checkoutfields will not redefine pdf print models, to prevent conflicts with \n other pdf modules. To enable checkoutfields printing, follow instructions from \n checkoutfields configuration options', 'http://bit.ly/1d9NOAC', 0, 1),
(181, 4, '2013-07-11 07:24:26', 'Increase your store speed up to 400% with Page Cache extension!', NULL, 'http://bit.ly/12tDWM3', 0, 1),
(182, 4, '2013-08-05 08:54:01', 'Improve your products page design with Easy Tabs 2.0', 'Easy Tabs  2.0 is now available with next new features:\n\n- New backend interface with separate page\n- Skins and templates moved to base folder\n- Unlimited number of tabs\n- Responsive styles added', 'http://bit.ly/16uYnOn', 0, 1),
(183, 4, '2013-08-08 05:25:38', 'Magento Page Cache 1.0.2 is now available', 'Magento Page  Cache 1.0.2 is now available with next new features:\n\n- Session params added to cache key at required pages (listing mode, limit etc)\n- Added support of dynamic blocks in custom_layout_update xml directive\n- Fixed cache cleaning when mass delete is used\n- Added support for cache auto refresh for Quickshopping module\n\n', 'http://bit.ly/13IPu3j', 0, 1),
(184, 4, '2013-08-14 07:48:05', 'Argento 1.3 is now available with backend CSS configuration ', 'Argento update:\n\nArgento update\n*    Fixed displaying of decimal quantities in header cart\n*    Removed overriding of customer.xml layout\n*    Css styles was refactored. Duplicate code removed.\n*    Automatic inclusion of custom.css file from active theme skin folder\n\nBackend configuration for theme styles added\n*    Background\n*    Top navigation\n*    Buttons (ArgentoPure only)\n*    Tabs\n*    Fonts\n*    Additional custom css\n*    Ability to add additional head links (Google fonts for example)\n\nEasytabs\n*    Easy tabs 2.0 integrated\n\nAjaxSearch\n*    Fixed search form submit by clicking the search button\n\nSuggestPage\n*    ajaxpro compatibility fixed\n\nAjaxPro\n*    Fixed wishlist link for secure pages\n\nHighlight\n*    Currency code added to cache key\n*    Fixed building of product url, when category path in product url is disabled from backend\n*    Fixed filtering of the one day only available products\n\nSoldTogether\n*    Fixed filtering of products on suggestpage\n*    Fixed price formatting for amazon style template\n\nCore\n*    Notifier filter by news channel added\n*    Magento 1.4 compatibility added', 'http://bit.ly/16brXYz', 0, 1),
(185, 4, '2013-08-19 05:51:11', 'Newsletter Booster 1.2.0 with advanced newsletter features is now available', 'Newsletter Booster 1.2.0 is now available with next new features:\n\n- Campaigns can be set to be visible on front end so customers can subscribe to one that they are interested at\n- Subscribers can now un-subscribe and subscribe from separate segments\n- Separate newsletter tab is added to customer''s My account page\n- Send to multiply segments option was added in admin interface\n- Guest subscribe and queue\n- Support for anonymous email gateways\n- utm_content content support \n', 'http://bit.ly/19tgPay', 0, 1),
(186, 4, '2013-08-27 05:16:21', 'Improve your Magento store admin security with Improved admin security 2.0 extension ', ' Improved admin security 2.0 extension   is now available with next new features:\n\n- Admin actions logs added\n- Advanced control over admin user ip address used added\n- Admin login actions log added\n', 'http://bit.ly/1djLRFY', 0, 1),
(187, 4, '2013-09-02 07:21:50', 'Increase your revenue with Firecheckout 2.4.5 ', 'Fire Checkout 2.4.5 is now available with next new features:\n\n- Added support for quantity increments when using +/- buttons in shopping cart\n- AddressFields status save: Warning message removed in Magento 1.5.0.1 and earlier.\n- Validate form method created to allow to validate firecheckout form from any script\n- Success page url changed to checkout/onepage/success to provide compatibility with third party tracking extensions\n- Fixed saving guest email and phone to quote on address refresh\n- Fixed saving of last selected address for registered users\n- Fixed sending order confirmation emails for magento 1.4.2\n- Fixed updating OrderReview section in IE10\n- Fixed click on single available payment method\n- Fixed error in billing form, when Mage_Newsletter module is disabled.\n- Imporved check for Mage_Capcha module. Added check for etc/modules status.\n- Added synchronization of klarna invoice form with address form\n- Infostrates TNT shipping method support added (need to edit tnt.js to add event firing, when ajax request is completed)\n- TigPostcode extension templates updated to the latest version\n- Givechange module integration\n- Klarna part integration added\n- Partial Amasty coupons integration. Still needs to edit Amasty_Coupons_Block to change template.\n- Partial webtext giftcard integration. Still need to edit giftcard.xml and CartController.php', 'http://bit.ly/1fus5EF', 0, 1),
(188, 4, '2013-09-06 07:19:20', 'Magento Easy Lightbox extension 3.0 is now available', NULL, 'http://bit.ly/17dnWDp', 0, 1),
(189, 4, '2013-09-10 05:15:35', 'Argento 1.3.1 is available. Now compatible with Magento Enterprise edition!', 'Argento update\n*    Magento Enterprise Edition compatibility\n*    Sweet tooth reward integrated into shopping cart template\n*    Main product image size increased to 370px\n*    Subtotal added to cart popup for Argento theme\n*    Fixed output of tags and other inline links, when html minifier extension is used\n*    Added additional theme fallback rules to simplify enterprise version compatibility\n*    Fixed broken print invoice page\n*    Fixed double call for EasyTabs block\n\nAjaxSearch updated\n*    Fixed filling the dummy search text after double click on input field\n*    Fixed sorting of categories in category combobox\n*    Fixed category search results\n*    Fixed automatic applying filter by category on search results page\n*    Layout and templates moved to base/default/tm folder\n\nEasyTabs updated\n*    Added missing containers to tag and review blocks\n*    Layout and templates moved to base/default/tm folder\n\nTM_Core updated\n*    Fixed error when AdminNotification module is disabled\n\nSoldtogether\n*    Updated to the newest version\n*    Fixed updating of the main product price, when soldtogether products are not found\n\nEasyCatalogImages\n*    Layout and templates moved to base/default/tm folder\n*    Fixed imagepath detection. Possible bug when media is used in domain name\n\nEasyBanner\n*    Fixed imagepath detection. Possible bug when media is used in domain name\n*    Added check for banner availability in store, when inline banner call is used\n', 'http://bit.ly/1b0Y0is', 0, 1),
(190, 4, '2013-09-19 05:10:33', 'Magento Page Cache 1.0.3 is now available!', 'Magento Page  Cache 1.0.3 is now available with next new features:\n\n- Compilation mode compatibility added\n- Fixed developer and inline translate modes per IP address\n- Fixed output of dynamic blocks called with inline method from cms block or page\n- Cache autorefresh support added for: TM_Askit, AW_Productquestions\n', 'http://bit.ly/1aNvf6g', 0, 1),
(191, 4, '2013-09-26 07:04:04', 'Magento Quick Shopping 1.2.3 is now available', 'Magento Quick Shopping 1.2.3 is now available  with next new features:\n\n- Responsive styles added\n- Removed big gap between image and content for wide quickshopping popup\n- Added ability to display additional images gallery in quickshopping window\n- Configuration options regrouped\n- Translation optimizations\n- Code cleanup\n', 'http://bit.ly/1eJTFBR', 0, 1),
(192, 4, '2013-10-07 07:25:35', 'Fire Checkout 2.4.6 is now fully compatible with Magento 1.8', 'Fire Checkout 2.4.6 is now available with next new features:\n\n-  Magento 1.8 code sync\n-  Secure key added to firecheckout form\n-  Fixed gradient image for firecheckout form sections\n-  DeliveryDate feature: Period in days when delivery will be available, since first available day\n-  Update of IrvineSystems modules integration\n-  TNT Infostrates observer fixed for ajax reloaded shipping methods\n-  Improved check for modules enabled status.\n-  J2t Rewardpoints integration updated\n\n', 'http://goo.gl/Tlv5Qu', 0, 1),
(193, 4, '2013-10-15 08:16:04', 'Argento 1.3.2 is available. Now fully compatible with Magento CE 1.8', 'Argento updates:\n\n*   Magento 1.8 compatibility\n*   Fixed custom.css url on secure pages\n*   custom.css is now included after theme.css\n*   AjaxPro popup styles improved\n*   Cookie restriction message made responsive\n*   Css fixes\n*   QuickShopping is now supported. No need to edit listing template.\n*   Various small fixes to all modules. More than 70 commits was done.\n', 'http://goo.gl/2PPWxD', 0, 1),
(194, 4, '2013-10-28 05:29:51', 'Make your store faster with Magento Page Cache 1.1 ', 'Magento Page  Cache 1.1.0 is now available with next new features:\n\n- Added per-page lifetime configuration\n- Added support for SmartSuggest blocks\n\n', 'http://goo.gl/unQtt5', 0, 1),
(195, 4, '2013-11-04 07:26:32', 'All our Magento themes and extensions are now fully compatible with Magento CE 1.8', 'We are glad to inform that all our templates were recently updated to Magento CE 1.8. Request your update at http://bit.ly/q51qxj ', 'http://goo.gl/w6tyCx', 0, 1),
(196, 4, '2013-11-07 08:14:03', 'Improve your checkout and order success page with Fire Checkout 2.5', '  Fire Checkout 2.5.0 is now available with next new features:\n\n-   Ability to add additional content on firecheckout page added\n-   Success page module added to firecheckout, that allows to customize order success page\n-    Fixed delivery date visibility in backend, when editing the order\n-    Resources moved to tm subfolder\n-    Netresearch_Billsafe module integration updated\n-    Improved AW_Rewards compatibility\n-    Removed warning about not existing Netresearch_Billsafe class\n-    Firecheckout_Adminhtml_Model moved to standard model folder\n-    firecheckout/review.phtml rewrite removed from checkoutfields module\n-    Dynamic layout loading added, that helps to provide out of the box integration with following modules:\n    AW_Newsletter, Billpay, Bysoft_Relaypoint, CraftyClicks, Ebizmarts_SagePaySuite, Enterprise_Enterprise, GCMC_GiveChange, Geissweb_Euvatgrouper, IntellectLabs_Stripe, IrvineSystems_Deliverydate, IrvineSystems_JapanPost, IrvineSystems_Sagawa, IrvineSystems_Seino, IrvineSystems_Yamato, Kiala_LocateAndSelect, Klarna_KlarnaPaymentModule ,Mage_Captcha, Magestore_Storepickup, MageWorx_MultiFees, Netresearch_OPS, Payone_Core, Phoenix_Ipayment, Rewardpoints // J2t Rewardpoints, Symmetrics_Buyerprotect, TIG_Postcode, Webtex_Gitcards\n    Unfortunately some of the modules still needs to be edited. But FireCheckout sources is ready to use without any modifications.-', 'http://goo.gl/RN9aoY', 0, 1),
(197, 4, '2013-11-19 11:38:25', 'Attract your customers attention with custom products blocks and Products Highlight 2.4', 'Products Highlight 2.4 is now available with next new features:\n\n-   Added reset of std list styles to properly display highlight block on cms pages\n-   Templates and skin moved to base folder\n-   Fixed filtering of the one day only available products\n-   Fixed building of product url, when category path in product url is disabled from backend\n-   Added currency code to cacheKey', 'http://goo.gl/8MVkyR', 0, 1),
(198, 4, '2013-11-26 09:24:00', 'Fire Checkout 2.5.1 is now available', 'Fire Checkout 2.5.1 is now available with next new features:\n\n- J2t Rewardpoints integration updated\n- Added additional reset styles and clears\n- Fixed output of the delivery date for different timezones\n- Updated template paths to include tm prefix\n- Fixed order submit button for virtual products\n- Fixed saving of the entered taxvat number on page reload\n- Checkoutsuccess page is now compatible with thrd-party order total modules\n- AW_Points integrated into checkoutsuccess page', 'http://goo.gl/pphCjN', 0, 1),
(199, 4, '2013-12-13 07:29:25', 'Make your shopping as fast as lighting with Ajax Pro 3.0', 'Ajax Pro 3.0 is now available with next new features:\n\n- Improved ajax update algorithm \n- Allows to show shopping cart, coupon code block and related products block in ajax cart window\n- Configurable list of blocks for ajax refresh for each action\n- Improved ajax progress window\n- Improved usability for add to cart and add to compare ajax action\n- Improved modal window script\n', 'http://goo.gl/0ces1y', 0, 1),
(200, 4, '2013-12-16 07:20:50', 'Create attractive landing pages and improve store navigation with Magento Brands and Attributes pages extension!', NULL, 'http://goo.gl/yp998j', 0, 1),
(201, 4, '2013-12-20 07:32:25', 'Improve traffic from search engines to your Magento store with Google Rich snippets 1.3.0', ' Rich snippets 1.3.0 is now available with next new features:\n\n-  Added Google+ Author feature support\n-  Added Breadcrumbs feature support\n-  Resources moved to base folder\n', 'http://goo.gl/PY54Zf', 0, 1),
(202, 4, '2013-12-24 06:04:53', 'Celebrate Christmas and save 20% on all themes and extensions with coupon code XMAS2013', 'We are glad to tell that our Christmas special offer starts today and it''s a great chance to get any our Magento extensions or template with 20% discount (). Our special offer ends on January 01 2014 so don''t miss your chance to improve your store!', 'http://goo.gl/368va0', 0, 1),
(203, 4, '2014-01-02 07:06:56', 'Improve your layered navigation with Ajax Layered Navigation 2.2', 'Ajax Layered Navigation 2.2 is now available with next new features:\n\n-    Improved slider javascript\n-    Now supports multiple sliders on same layered navigation block\n-    Added support for advanced layered navigation page\n-    Improved overall performance\n-    Attributes sort order fixed\n-    Fixed support of third level of seo url', 'http://goo.gl/qvWFBp', 0, 1),
(204, 4, '2014-01-08 01:44:42', 'Argento 1.4.0 with great Brands pages extension is now available. Now fully compatible with Magento CE 1.8.1! ', 'Argento updates:\n\n*   Magento 1.8.1 compatibility\n*    Attributepages and brands extension added\n*    Mobile navigation with backend configuration added\n*    Product page markup improved for mobile devices\n*    Css styles for small screen devices improved\n*    Contact form improvements: added tel and email types\n*    QuickShopping support added to pure theme product listing\n*    Fixed page zoom for touch devices, when focusing input elements\n*    Bugfix: TabBuilder: Cannot call method ''addClassName'' of undefined\n*    Fixed positioning of grouped item availability status\n*    Bundle for 1702 and older magento versions fixed\n*    Missing translations added\n*    Suggestpage integrated into ajaxpro popup window\n*    Soldtogether random collection is enabled for initial installation now\n*    AjaxPro\n*        Completely rewritten layout and blocks generating logic\n*        Configurable popup added\n*        Responsive styles added\n*        Various css and js fixes\n*        Improved css styles for all popups\n*        Improved overlay and spinner positioning\n*        Fixed ajax product listing on layered categories\n*        Overlay fade effect fixed\n*        Popup autohide functionality improved\n*        Fixed moving product to wishlist from shopping cart page\n*    Askit\n*    Attribute and Brands pages NavigationPro Integration\n*        Module is added to Argento\n*    EasyCatalogImg NavigationPro Integration\n*        Better integration with NavigationPro\n*        Added ability to select root category and filter categories to show/hide per widget.\n*    Easyslide\n*        Bugfix: https image url support added\n*    EasyTabs\n*        Added ability to get direct link to any tab\n*    LightboxPro\n*    NavigationPro\n*        Added mobile menu support\n*    RichSnippets\n*        Breadcrumbs support added\n*        Author support added\n', 'http://goo.gl/rIkhtH', 0, 1),
(205, 4, '2014-01-13 08:12:24', 'Fire Checkout 2.5.2 is now available', 'Fire Checkout 2.5.2 is now available with next new features:\n\n-   MageWorx_CustomerCredit integration updated\n-   AW_Advancednewsletter module integration added\n-   Taxvat validator now can receive number with coutry code\n-   Static block moved outside of ajax reloading review table block\n-   Rewardpoints reload added, when changing cart items\n-   Magento 1.8.1 compatibility. Wee tax calculation template ported from 1.8.1', 'http://goo.gl/S7WsMA', 0, 1),
(206, 4, '2014-01-17 03:58:04', 'Ajax Pro 3.1 is now available', 'Ajax Pro 3.1 is now available with next new features:\n\n- Added ability to integrate third-party module into ajaxpro popup\n- Improved css styles for all popups\n- Responsive styles added\n- Improved overlay and spinner positioning\n- Fixed ajax product listing on layered categories\n- Overlay fade effect fixed\n- Popup autohide functionality improved\n- Fixed moving product to wishlist from shopping cart page', 'http://goo.gl/Bjj1ha', 0, 1),
(207, 4, '2014-01-20 09:20:09', 'Magento Absolute and Classic themes are now fully compatible with Magento CE 1.8.1', NULL, 'http://goo.gl/Vx1MXY', 0, 1),
(208, 4, '2014-01-27 08:53:55', 'Meet new Magento templates prices from Templates Master!', NULL, 'http://goo.gl/E73JG9', 0, 1),
(209, 4, '2014-02-03 07:41:32', 'Improve your social media presence with Social Suite 1.4.0', 'Social Suite 1.4.0 is now available with next new features:\n\n- Optimized module configuration\n- Fixed aligment of social buttons\n- Secure head url fixed\n- Redesigned social discount modal window\n- Added responsive support for social discount modal window\n- Moved layout, template, css, js files to base/tm folder', 'http://goo.gl/vTdUwR', 0, 1),
(210, 4, '2014-02-10 07:04:10', 'Fire Checkout 2.5.3 is now available', 'Fire Checkout 2.5.3 is now available with next new features:\n\n-   SmartPost integration added\n-    Fixed applying of the payment method, when price filter for methods is used\n-    Backgrounds merged into single sprite image\n-    Removed popup window sprite image. Css3 is used instead.\n-    Overlay removed. Compatibility with address by postcode detection\n-    Klarna payment method integration update\n-    J2t Rewardpoints integration update\n-    SagePaySuite integration fix\n-    Additional css reset styles\n-    Module sort order updated\n-    Added error message about missing USPS user_id\n-    Address verification links replaced with buttons\n-    Additional checkmoney styles added to fix some themes', 'http://goo.gl/fXiMNb', 0, 1),
(211, 4, '2014-02-17 07:58:31', 'Improve your store navigation with Easy Catalog Images 2.3', 'Easy Catalog Images 2.3 is now available with next new features:\n\n-  Ability to hide block, when filter or pagination is applied.\n-  Ability to show widget on category pages, when category config is disabled.\n-  Widget: Ability to set Root Category to load\n-  Widget: Ability to show and hide specific categories\n-  NavigationPro integration styles added\n-  NavigationPro integration guide\n-  Automated thumbnail assignment added. Script can fill category thumbnails with image of first product of corresponding category. If category has attached thumbnail already, it will be skipped.         Only direct category children are processed. If category has no direct child products, thumbnail will not be assigned\n-  Css refactoring. Responsive styles added\n-  Added note about supported columns count to the widget interface\n-  Module sort order updated', 'http://goo.gl/feTo0q', 0, 1),
(212, 4, '2014-02-26 07:14:00', 'Magento Attributes and Brands pages extension 1.0.1 is now available', 'Magento Attributes and Brands pages extension 1.0.1 is now available with next new features:\n\n-   Improved NavigationPro integration styles\n-   Added support for category layer filter\n-   Added validation of width and height parameters\n-   Backend menu title renamed to Manage Options\n-   Products-grid class removed to prevent issues with third party themes\n-   std styles reset added', 'http://goo.gl/gB3E1O', 0, 1),
(213, 4, '2014-03-03 08:34:53', 'Improve your Magento store speed with Page Cache 1.1.2', 'Magento Page Cache extension 1.1.2 is now available with next new features:\n\n-   Fixed working in cookie restriction mode\n-   Added compatibility with some ajax extensions. isAjax flag added to cache key.\n-   Module sort order updated', 'http://goo.gl/bjDTBu', 0, 1),
(214, 4, '2014-03-07 05:35:40', 'Easy Slider 2.2 is now available !', 'Magento Easy Slider  extension 1.2.0 is now available with next new features:\n\n-  Slider description now can render magento variables, widgets, etc.\n-  Backend menu moved to Templates-Master submenu.\n-  Backend url is now using the admin prefix\n-  Templates and resources moved to base folder\n-  Glider object renamed to Easyslider', 'http://goo.gl/LcPL7J', 0, 1),
(215, 4, '2014-03-11 08:45:02', 'Sold Together 1.3.3 is now available!', 'Magento Sold Together 1.3.3 is now available with next new features:\n\n-   Resource files moved to base/tm folder\n-   Javascripts moved to separate file\n-   Add to cart checkboxes restyled\n-   Integration with AjaxPro popup message added\n-   Added missing translations\n-   SuggestPage updated to the newest version.', 'http://goo.gl/O9DMUC', 0, 1),
(216, 4, '2014-03-18 09:04:40', 'Smart Suggest 1.3.1 is now available!', NULL, 'http://goo.gl/k4FN6u', 0, 1),
(217, 4, '2014-03-21 07:42:34', 'Sold Together 1.3.5 is now available!', 'Magento Sold Together 1.3.5 is now available with next new features:\n\n-    Added price with/without tax support in amazon style list\n-    Fixed total recalculations, when discount is available\n-    Fixed price parsing for specific locales\n-    Filter/Sorting by weight fixed in backend\n-    Module sort order updated\n\n', 'http://goo.gl/mAfG1r', 0, 1),
(218, 4, '2014-03-27 09:03:07', 'Ajax Search 1.4 is now available', 'Ajax Search 1.4 is now available with next new features:\n\n-   Unicode support was updated\n-   Added ability to hide categories in combobox\n-   Config was refactored\n-   Translations updated\n-   Small styles improvements\n-   Fixed bug when & is not rendered as &amp;\n\n\n', 'http://goo.gl/1VFTbM', 0, 1),
(219, 4, '2014-03-31 04:44:21', 'Fire Checkout 2.5.4 is now available', 'Fire Checkout 2.5.4 is now available with next new features:\n\n- Backend delivery date output for Magento 1.5 fix\n- Added renderer for downloadable item in cart\n- Removed alert about existing customer when updating billing address\n- Additional link styles added for email exists window\n- Radweb_Stripe integration added\n- Customweb_PayUnity integration added\n- Braintree integration updated\n- SmartPost integration updated\n- Aitoc_Aitgiftwrap integration added\n- PostcodeNl_Api compatibility added\n- Magestore_Storepickup integration', 'http://goo.gl/q1sRRW', 0, 1),
(220, 4, '2014-04-04 05:48:05', 'Products Highlight 2.4.1 is now available', 'Highlight 2.4.1is now available with next new features:\n\n- Added form_key and uenc support with cache enabled\n- Missing variables added to abstract class\n- Added translation to page title of highlight page\n- Bestsellers and popular collection query made compatible with getAllIds query\n- Added missing message block to the highlight page\n- Magento EE fix added\n- Added missing messages block on highlight pages', 'http://goo.gl/euj83t', 0, 1),
(221, 4, '2014-04-14 06:08:26', 'Improve your store navigation with Attributes and Brands pages extension 1.1.0 ', 'Magento Page Cache extension 1.1.2 is now available with next new features:\n\n-  Improved router logic for multistore setup and disabled pages\n-  Fixed blocks logic to remove page duplicates in multistore mode\n-  Group by first letter made case insensitive\n-  Magento EE layered filters compatibility\n-  Fixed layered filter by category with attribute\n-  Fixed reset layered filter by category\n-  Fixed ACL rule paths\n-  Fixed page routing, when single/doublequote is used in url', 'http://goo.gl/1CBbmn', 0, 1),
(222, 4, '2014-04-17 05:13:50', 'Celebrate Easter and get 20% discount on all our products (coupon code EASTER14) ', NULL, 'http://goo.gl/RhDM3F', 0, 1),
(223, 4, '2014-04-21 22:37:56', 'Argento 1.5.0 with new Mall design is now available', NULL, 'http://goo.gl/YxlUrp', 0, 1),
(224, 4, '2014-04-28 00:31:00', 'Make your store faster with Magento Page Cache 1.1.3', 'Magento Page Cache extension 1.1.2 is now available with next new features:\n\n-   Better compatibility with third-party themes and custom block rendering.', 'http://goo.gl/isS75Y', 0, 1),
(225, 4, '2014-05-05 07:20:49', 'Quick Shopping 1.2.7 is now available', 'Quick Shopping 1.2.7 is now available with next new features:\n\n-   Fixed possible non-seo links in search results or root categories\n-   Added compatibility with Magento use_category_url option\n-   Quickshopping window made hidden after AjaxPro call\n-   Next and prev links on attributepages are now supported\n-   Additional css reset added', 'http://goo.gl/5UNNeA', 0, 1),
(226, 4, '2014-05-07 05:28:59', 'Attributes and Brands pages extension 1.2.0 is now available', 'Attributes and Brands pages extension 1.2.0 is now available with next new features:\n\n-   Added ability to show option information on product page\n-   Improved parent page detection for options block\n-   Default product list block is now used for attribute page\n-   Image resize helper improvements', 'http://goo.gl/oeyOvc', 0, 1),
(227, 4, '2014-05-12 02:44:22', 'Increase your store sales with Firecheckout 2.5.5', 'Fire Checkout 2.5.4 is now available with next new features:\n\n-   Removed ability to buy downloadable product without registration\n-    Fixed applying address for customer with default addresses\n-    Fixed missing checkout button when onepage checkout is disabled\n-    Removed shipping form synchronization with billing form\n-    Added address form reset when new address is selected\n\nThird-party modules integrations\n\n-    Bpost_ShippingManager\n-    Tig_MyParcel\n-    Amasty_Deliverydate\n-    Magebuzz_Rewardpoint\n-    SagePaySuite directpro integration unpdated\n-    Phoenix_Ipayment integration updated\n-    z-index for window and mask increased. Ultimo integration', 'http://goo.gl/AkQOCW', 0, 1);
INSERT INTO `adminnotification_inbox` (`notification_id`, `severity`, `date_added`, `title`, `description`, `url`, `is_read`, `is_remove`) VALUES
(228, 4, '2014-05-15 01:20:52', 'Take full control over your store navigation with Navigation Pro 1.3.1', 'Navigation Pro 1.3.1 is now available with next new features:\n\n-     Fixed cache entity key detection on product page (Bug with invalid active menu on product page)\n-    Fixed css styles for mobile menu\n-    Added css reset of navpro inside std class\n-    Added form_key and uenc support when cache is enabled for child widgets\n-    Translations included to the frontend\n-    isSecure flag added to menu cache key\n-    Fixed dropdown content rendering for the category without children\n-    Module sort order updated\n-    Added ability to render mobile specific menu\n', 'http://goo.gl/kEvoIX', 0, 1),
(229, 4, '2014-05-19 08:58:52', 'Make shopping really fast with Ajax Pro 3.2', 'Ajax Pro 3.2 is now available with next new features:\n\n-    Ajax Layered Navigation integration was added\n-    Toolbar block was re-factored\n-    Fade effect removed because of bug with opacity in Firefox\n-    AjaxPro pop-up styles updated\n-    Added CAPTCHA support for the login block\n-    Cross domain support was added\n-    IE10 compatibility improved\n-    Multiply small bugs fixes and improvement', 'http://goo.gl/UT0Q6s', 0, 1),
(230, 4, '2014-05-22 04:52:00', 'Make your site mobile friendly with Mobile Star Theme 1.3', 'Mobile Star Theme 1.3  is now available with next new features:\n\n-   PhotoSwipe image gallery added instead of scrollable images on product page. See the video about the gallery\n-   app/design/frontend/default/m001/template/checkout/multishipping/addresses.phtml updated according to Magento 1.9\n-   Easyslider and Highlight updated to latest versions', 'http://goo.gl/Xf5UKb', 0, 1),
(231, 4, '2014-05-26 06:04:52', 'Attract your customers attention with Prolabels 2.5.0', 'Prolabels 2.5.0  is now available with next new features:\n\n-   Add new label type - "content"\n-   Improved usability of labels on mobile devices\n-   Add new config options - Move labels to content wrapper on mobile devices\n-   Added tooltip option\n-   Added config options for tooltip ( Text and Background Colors )\n-   Added new predefined variables #attr:attribute_code#\n-   Added default value for round settings\n-   Fixed system labels predefined variables text\n-   Removed indexing for system labels', 'http://goo.gl/DsdtCS', 0, 1),
(232, 4, '2014-05-30 06:06:47', 'Argento 1.5.1 is now available!', NULL, 'http://goo.gl/rqZtQj', 0, 1),
(233, 4, '2014-06-01 22:48:18', 'Firecheckout 2.5.6 is now available', 'Fire Checkout 2.5.6 is now available with next new features:\n\n    Added housenumber script, that allows to replace the second address line with housenumber field.\n    Fixed AddressReview update when clicking the "Ship to the same address" checkbox\n    Fixed error in downloadable item renderer path\n    Added small css and js fixes for Magento 1.9 rwd theme\n    Greek taxvat code validation fix\n    Inchoo_SocialConnect integration added', 'http://goo.gl/WIVLwc', 0, 1),
(234, 4, '2014-06-09 08:53:59', 'Full Page Cache 1.1.4 is now available!', 'Full Page Cache 1.1.4 is now available with next new features:\n\n    Cache cleanup improvements. Frontend actions are now processed too. Corresponding cache entries are cleaned on the following actions:\n        Order place/cancel\n        Approved tag assignment\n        Approved review\n        Approved askit question or answer', 'http://goo.gl/wK8Bgc', 0, 1),
(235, 4, '2014-06-12 07:46:25', 'Easy Tabs 2.2.1 is now available ', 'Easy Tabs 2.2.1 is now available with next new features:\n\n    Click on review link now automatically activate and scrolls to review tab\n    RWD support added.\n    Unset option made visible for all tabs\n    Reccuring Info tab added to default setup.\n    Added new tab type (html content) to simplify adding of inline html blocks\n    Added Save and continue edit button\n    Unusable easytabs removed from widget list dropdown\n    Added public events to allow to run some javascript on tab activate/deactivate.\n    Code refactoring and formatting\n    Added support for customer added tabs without _tabbed suffix\n    Added check for empty content before output to prevent rendering empty tabs\n    Css completely rewritten for better styles\n    Accordion styles added for mobile devices\n    Module sort order updated', 'http://goo.gl/ce56ip', 0, 1),
(236, 4, '2014-06-23 05:13:36', 'Create successful ads using Easy Slider 2.2.2', 'Easy Slider 2.2.2 is now available with next new features:\n\n    - Five locales where added: es_ES, fr_FR, it_IT, nl_NL, pt_PT\n    - Added target option for each slide link: Same window, New window, Popup', 'http://goo.gl/RkS9TG', 0, 1),
(237, 4, '2014-07-01 22:50:22', 'Increase your store sales with Firecheckout 2.5.7', 'Fire Checkout 2.5.7 is now available with next new features:\n\n    Added ability to select vat field to validate (taxvat vs vat_id)\n    TemplateTag_Stripe compatibility added\n    Emja_Taxrelief support\n    Webshopapps_Wsafreightcommon support\n    Emjainteractive_ShippingOption support\n    Fixed integration with latest Paymill payment\n    Added ability to redirect to firecheckout page if firecheckout param is found in url', 'http://goo.gl/BQhH5Z', 0, 1),
(238, 4, '2014-07-08 02:58:55', 'Great new pop-up welcome banners and much more with Easy banners 1.4.1', 'Easy banners 1.4.1 is now available with next new features:\n\n    Lightbox banners added\n    Awesomebar banners added\n    New filters: Display count per customer, Inactivity time, Activity time, Browsing time, Page scroll offset\n    Resources moved to base theme\n    Added ability to set the class name for banner\n    Five locales where added\n    Module sort order updated\n\n    ', 'http://goo.gl/6uW0ky', 0, 1),
(239, 4, '2014-07-11 04:44:26', 'Easy Tabs 2.3.0 is now available  ', 'Easy Tabs 2.3.0 is now available with next new features:\n\n    Five locales where added\n    Dynamic tabs titles now include reviews, tags, questions count\n    Added ability to unset multiple blocks from single tab\n    Fixed first tab activating, when external links are available\n    Tab titles for tags and reviews made shorter\n    Fixed tabs with image content only or other tag only content\n\n   ', 'http://goo.gl/22oome ', 0, 1),
(240, 4, '2014-07-21 08:50:02', 'Improve your store speed with Magento CDN module 1.0', NULL, 'http://goo.gl/GC5rhx', 0, 1),
(241, 4, '2014-07-28 06:32:43', 'Argento 1.5.2 is now available', NULL, 'http://goo.gl/NQXiVj', 0, 1),
(242, 4, '2014-07-29 08:27:28', 'Easy Colors Swatches 2.0 with new great features is now available  ', 'Attribute Swatches - only product page\n\n    Added support for attribute swatches data\n    Changed base image from simple product ( attribute swatches type only - optional )\n    Added config option Product page base image width and height ( attribute swatches type only )\n    Added new config options - Product page base image path ( attribute swatches type only )\n    Added support for LightBoxPro image view module\n    Changed shopping cart image from simple product\n\n\nProduct Swatches\n\n    Added suppot for resize base image in catalog page\n    Added config option Catalog page grid mode base image width ( for grid mode image resize )\n    Added config option Catalog page list mode base image width ( for list mode image resize )\n    Added config option Event for activation catalog swatch item ( click or hover )\n    Fixed css style for image and text type swatches\n', 'http://goo.gl/032cj7', 0, 1),
(243, 4, '2014-08-06 08:51:11', 'Improve your customer service with new Helpmate 1.5.1', 'New features\n\n    TM Email sub module was divided and his functionality was extended. Transport email was added. Queue functionality was added.\n    Department statistics was added.\n    Now you can add custom ticket statuses.\n    Ticket number was shorted.\n    Recent tickets tab was added on admin dashboard.\n    Improved SEO of knowledge-base urls on frontend.\n    Customers tickets grid was added on admin customer interface.\n    Order tickets grid was added on admin order interface.\n    Now you can preview customer info in ticket in quick view window.\n    Support variables and widgets was added in ticket answers.\n    Archive email was added. All tickets notification will be sent to that email.\n    Magento api v2 support was added.\n    Files upload and download is now handled via separate controller.\n    Customers will get Captcha now in case of SPAM positive Akismet results.\n\nFixes & improvements\n\n    Localisation was improved.\n    Potential XSS bug was fixed.\n    Fixed meta titles for KB and tickets pages.\n    Knowledge-base js auto-complete class was renamed to prevent conflict with AjaxSearch.\n    Max_file_upload value is now checked during file upload.\n    SMTP Pro Email compatibility was added.\n    Image preview was added in tickets interface.\n    WYSIWYG editor url directives bug was fixed.\n    Department getOptionsArray bug was fixed.\n    and much more..', 'http://goo.gl/VzUnnV', 0, 1),
(244, 4, '2014-08-11 07:20:05', 'Make your store faster with Magento Page Cache extension 1.2.0', NULL, 'http://goo.gl/VYMWTw', 0, 1),
(245, 4, '2014-08-19 04:00:57', 'Our new free Magento Testimonials module is now available for download!', NULL, 'http://goo.gl/9u1yz7', 0, 1),
(246, 4, '2014-09-01 11:21:55', ' Ask It 2.1 is now available', NULL, 'http://goo.gl/FgBLxp', 0, 1),
(247, 4, '2014-09-08 01:42:18', 'Magento Attributes and Brands pages 1.2.1 is now available', NULL, 'http://goo.gl/X9OhE0', 0, 1),
(248, 4, '2014-09-15 05:06:48', 'Full Page Cache 1.3.2 with new admin interface is now available!', 'Features\n    New Dashboard page with cache backend info, benchmark grid and activity chart\n    New Cache Usage page\n        Cache records usage with hits count and latest access time\n        Request Information\n        Ability to delete old or selected cache records\n    New Cache Activity Log page\n        Recent requests with detailed info and miss/hit result\n    Added configurable automatic removing of unused cache records\n    Added ability to disable caching of certain pages by request_path string match\n\nImprovements\n    Added automatic cache cleaning for complex product types\n        Bundle\n        Configurable\n        Grouped\n\nFixes\n    noRoute page added to disabled pages list\n    Amasty_ShopBy integration\n    Added tag prefix to prevent collisions with magento layout cache records\n', 'http://goo.gl/QPucfK', 0, 1),
(249, 4, '2014-09-22 07:46:23', 'Magento Products Highlight 2.4.3 is now available', NULL, 'http://goo.gl/M8IUAY', 0, 1),
(250, 4, '2014-09-25 02:15:42', 'Firecheckout 2.5.8 is now available for download', 'Fire Checkout 2.5.8 is now available with next new features:\n\n    End of delivery processing day feature added, which allows to set the first available delivery day more accurate\n    Webshopapps_Desttype integration\n    Partial Ebizmart_Magemonkey integration\n    Unirgy_GiftCert integration\n    Vaimo_Klarna integration added\n    TIG_PostNL integration\n    Fixed Braintree error message\n    Fixed billmate payment issue, when payment does not updated properly\n    Third-party modules css fixes\n    RWD theme fix\n    Removed link tag around agreement label', 'http://goo.gl/UFvXt0', 0, 1),
(251, 4, '2014-09-29 01:08:02', 'Improve your navigation with Ajax Layered Navigation 2.3', 'Ajax Layered Navigation 2.3 is now available with next new features:\n\n-    Fixed wrong sort product collection\n-    Fixed urls for seo layered navigation bug\n-    Removed possible XSS vulnerability for state remove link\n-    Fixed init price slider for accordion navigation style\n-    Added css style for Horizontal navigation style', 'http://goo.gl/FtMzhk', 0, 1),
(252, 4, '2014-10-06 03:03:56', 'Ask It 2.2 is now available', ' It 2.2 is now available with next new features:\n\n    Captcha support was added\n    Askit/list pager was added\n    Localisation was improved\n    Prefix translate on getItemViewLink was added\n    Table name bug was fixed', 'http://goo.gl/wuQzFF', 0, 1),
(253, 4, '2014-10-13 02:07:57', 'Improve your store speed with Magento CDN module 1.1', 'Magento CDN module 1.1 is now available with next new features:\n\n*  Debug performance test label was added\n*  Push images on CDN server from merged CSS files\n*  Beta Rackspace was released\n*  Backend config menu sort order was fixed\n*  Amazon AWS keys checking was added\n*  Added directives support to product description\n', 'http://goo.gl/K1fPtf', 0, 1),
(254, 4, '2014-10-16 08:36:59', 'Argento 1.5.3 is now available', NULL, 'http://goo.gl/28tFPk', 0, 1),
(255, 3, '2014-10-24 16:26:48', 'Firecheckout 2.6.0 is now available for download ', 'General\n\n    Added ability to set custom "I argee" text in popup window\n    Reworked ajax reload rules configuration\n    Retina display improvements\n    Better RWD theme support\n    Added ability to set the default shipping method for multiple shipping rates modules\n    Updated GeoDetection library and interfaces\n    GeoIP code improvements\n\nFixes\n\n    Fixed delivery date detection on Chrome browser\n    Norway localization renamed to nl_NO\n    Fixed spinner positioning\n\nIntegration\n\n    PostNL\n    IWD_OPC_Signature\n    Bitpay_Bitcoins\n    Aicod_Italy\n', 'http://goo.gl/EWd3jo', 0, 1),
(256, 4, '2014-10-30 11:19:08', 'Celebrate Halloween and get 15% discount on all our products (coupon code HLW14)', NULL, 'http://goo.gl/iyC2BM', 0, 1),
(257, 4, '2014-11-03 08:32:08', 'Magento Page Cache 1.3.3 is now available with Free Trial Version', NULL, 'http://goo.gl/EiT8s5', 0, 1),
(258, 4, '2014-11-11 02:53:56', 'Integrate your store with Social networks using our Social Suite 1.5.0', NULL, 'http://goo.gl/TzhttB', 0, 1),
(259, 4, '2014-11-14 05:31:20', 'Improve your store navigation with Attributes and Brands pages 1.3', 'Magento Attributes and Brands pages 1.3 is now available with next new features:\n  \n*    Added ability to show labels on category page\n*    Added page title attribute to provide possibility to use different page label in block or attribute page\n*    Thumbnail attribute added to display on product and category pages\n*    Added ability to load multiple options at once\n', 'http://goo.gl/nrfZz6', 0, 1),
(260, 4, '2014-11-17 08:44:36', 'Prozoom 1.3 is now available', NULL, 'http://goo.gl/B4l2KX', 0, 1),
(261, 4, '2014-11-24 10:12:24', 'Meet our new Magento Product Videos extension!', NULL, 'http://goo.gl/T1jcWU', 0, 1),
(262, 4, '2014-12-01 06:39:56', 'Prolabels 2.6.3 is now available', NULL, 'http://goo.gl/3zhES6', 0, 1),
(263, 4, '2014-12-04 06:03:18', 'Magento Layered Navigation 2.4.2 is now compatible with Magento CE 1.9.1', NULL, 'http://goo.gl/LVNpgw', 0, 1),
(264, 4, '2014-12-08 03:17:30', 'Firecheckout 2.6.1 is now available and compatible with Magento 1.9.1', NULL, 'http://goo.gl/oQoEWs', 0, 1),
(265, 4, '2014-12-11 06:13:02', 'Testimonials 1.0.1 is now available', NULL, 'http://goo.gl/cEvwzI', 0, 1),
(266, 4, '2014-12-15 03:18:35', 'Quick Shopping 1.2.8 is now available', NULL, 'http://goo.gl/Zck6qf ', 0, 1),
(267, 4, '2014-12-19 02:49:39', 'Celebrate Christmas and save 20% on all themes and extensions with coupon code XMAS2014', NULL, 'http://goo.gl/oRZFFU', 0, 1),
(268, 4, '2014-12-26 04:38:44', 'Prolabels 2.6.5 is now available', ' ', 'http://goo.gl/hhXslb', 0, 1),
(269, 4, '2014-12-30 09:09:35', 'Easy banners 1.4.2 is now available', NULL, 'http://goo.gl/3ejQpx', 0, 1),
(270, 4, '2015-01-02 06:22:51', 'Make your Magento admin more secure with Improved admin security 2.1', NULL, 'http://goo.gl/cuZML0', 0, 1),
(271, 4, '2015-01-12 07:49:19', 'Make your store mobile friendly with Mobile Star Magento template v.1.4', NULL, 'http://goo.gl/blP8In', 0, 1),
(272, 4, '2015-01-16 03:13:20', 'Ajax Search 1.5 is now available', NULL, 'http://goo.gl/ApcSxV', 0, 1),
(273, 4, '2015-01-21 02:02:45', 'Magento Products Highlight 2.4.4 with Retina support is available for download', NULL, 'http://goo.gl/KrUV5P', 0, 1),
(274, 4, '2015-01-25 09:07:58', 'Free Classic and Absolute templates version 2.0 with theme installer and swatches support is now available', NULL, 'http://goo.gl/qRUf4h', 0, 1),
(275, 4, '2015-01-28 08:40:14', 'Lightbox Pro 1.1 is now available', NULL, 'http://goo.gl/U0opFy ', 0, 1),
(276, 4, '2015-02-02 03:15:21', 'Firecheckout 2.6.2 is now available', NULL, 'http://goo.gl/xcYIbs', 0, 1),
(277, 4, '2015-02-06 06:40:16', 'Take full control over your store navigation with Navigation Pro 1.3.4', NULL, 'http://goo.gl/qwCBRT', 0, 1),
(278, 4, '2015-02-10 04:53:13', 'Make shopping process really easy with Ajax Pro 3.2.3', NULL, 'http://goo.gl/suXxQq', 0, 1),
(279, 4, '2015-02-13 04:53:00', 'St. Valentine''s Sale - "Buy more, save more". The offer is valid till February 15.', 'We are happy to start our special St. Valentine''s Sale - "Buy more, save more". Buy 1 item - Get 10% off. Buy 2 items - Get 15% off. Buy 3 items - Get 25% off. 25% Off. Hurry up! The offer is valid till February 15.', 'http://goo.gl/ExYnJN', 0, 1),
(280, 4, '2015-02-16 09:07:51', 'Easy Slider 2.3.0 is now available!', NULL, 'http://goo.gl/y29Czm ', 0, 1),
(281, 4, '2015-02-23 08:20:04', 'Mobile Star Magento template  1.4.1 is now available', NULL, 'http://goo.gl/nInfm4', 0, 1),
(282, 4, '2015-03-02 07:20:30', 'Quick Shopping 1.2.8 is now available', NULL, ' http://goo.gl/Zck6qf ', 0, 1),
(283, 4, '2015-03-10 04:23:16', 'Smart Suggest 1.3.3 is now available', NULL, 'http://goo.gl/MYZpA9', 0, 1),
(284, 4, '2015-03-16 11:04:37', 'Integrate your store with Social networks using our Social Suite 1.6.0 ', NULL, 'http://goo.gl/Emyx3j', 0, 1),
(285, 4, '2015-03-23 09:23:01', 'Easy Catalog Images 2.3.2 is now available', NULL, 'http://goo.gl/RDtCsZ ', 0, 1),
(286, 4, '2015-03-27 06:47:00', 'Argento 1.6.0 with new Flat design is now available!', NULL, 'http://goo.gl/i72t98 ', 0, 1),
(287, 4, '2015-03-31 01:20:59', 'Improve your email marketing with Newsletter booster 1.4', NULL, 'http://goo.gl/DRHX7M', 0, 1),
(288, 4, '2015-04-04 11:12:59', 'Celebrate Easter and get 20% discount on all our templates and extensions!', NULL, 'http://goo.gl/MPktZD', 0, 1),
(289, 4, '2015-04-07 10:00:33', 'Magento Products Highlight 2.5.0 with improved highlight pages is now available', NULL, 'http://goo.gl/UNYhyn', 0, 1),
(290, 4, '2015-04-19 04:12:51', 'Firecheckout 2.6.3 is now available', NULL, 'http://goo.gl/doAcxF', 0, 1),
(291, 4, '2015-04-26 16:29:17', 'Argento 1.6.1 is now available', NULL, 'http://goo.gl/GdcGBy', 0, 1),
(292, 4, '2015-04-30 14:01:08', 'Magento Facebook Like Button 2.0.1 is now available', NULL, 'http://goo.gl/9OZvQ1 ', 0, 1),
(293, 4, '2015-05-05 03:57:13', 'Prolabels 2.6.6 is now available', NULL, 'http://goo.gl/xkm4aq', 0, 1),
(294, 4, '2015-05-08 17:52:05', 'Mother''s day special deal: 15% off on all Magento extensions and templates!', NULL, 'http://goo.gl/UlqJ45', 0, 1),
(295, 2, '2015-05-12 11:12:03', 'Test your Magento admin interface for security vulnerability SUPEE-5344!', NULL, 'https://goo.gl/og4RE5 ', 0, 1),
(296, 4, '2015-05-18 05:17:55', 'Magento Page Cache 1.4 with site crawler is now available!', NULL, 'http://goo.gl/2n6Mdp', 0, 1),
(297, 4, '2015-05-25 11:18:56', 'Easy banners 1.5.0 is now available', NULL, 'http://goo.gl/DvX3US', 0, 1),
(298, 4, '2015-05-27 14:15:36', 'May special offer - Buy more, save more. Discount up to 30%!', 'It''s time to be rewarded for joining us in May! Get great deals on Templates-Master software. You will get 10% discount while ordering up to $100....20% for orders up to $200...30% for all orders over 200$. Kudos to everyone involved! The offer is valid till June 1, 2015.', 'http://goo.gl/QAvHDG', 0, 1),
(299, 4, '2015-06-01 09:58:06', 'Make your store faster with Magento Pages Speed extension!', NULL, 'http://goo.gl/IyyFJC', 0, 1),
(300, 4, '2015-06-09 23:15:54', 'Take full control over your store navigation with Navigation Pro 1.4.0', NULL, 'http://goo.gl/D9JKZH', 0, 1),
(301, 4, '2015-06-15 08:09:25', 'Magento Ajax Search And Autocomplete 1.5.2 is now available', NULL, 'http://goo.gl/ehbqJt', 0, 1),
(302, 4, '2015-06-18 09:01:37', 'Increase your store sales with Fire Checkout 2.7 and new order attachment module!', NULL, 'http://goo.gl/TiUlFV', 0, 1),
(303, 4, '2015-06-30 21:48:40', 'Make your Magento faster with Page Cache 1.4.2', NULL, 'http://goo.gl/UuwMIi', 0, 1),
(304, 4, '2015-07-03 02:59:41', 'Celebrate Independence day and get 20% discount on all our templates and extensions!', NULL, 'http://goo.gl/EbyTsm', 0, 1),
(305, 4, '2015-07-07 03:33:55', 'Pro Labels 2.7.0 is now available', NULL, 'http://goo.gl/6a8W4m', 0, 1),
(306, 4, '2015-07-14 06:29:46', 'Extensions and templates are now compatible with Magento Community Edition 1.9.2', NULL, 'http://goo.gl/xvD9OM', 0, 1),
(307, 4, '2015-07-17 02:32:03', 'Test your Magento store for SUPEE-5344, SUPEE-5994, SUPEE-6285 and  XML XXE vuln 2012 security vulnerabilities', NULL, 'https://goo.gl/WF0KNw', 0, 1),
(308, 4, '2015-07-24 16:13:55', 'Easy Catalog Images 2.3.3 is now available', NULL, 'http://goo.gl/YsD7UG', 0, 1),
(309, 4, '2015-07-30 06:54:39', 'Firecheckout 2.7.1 is now available ', NULL, 'http://goo.gl/CQLF5m ', 0, 1),
(310, 2, '2015-08-07 06:19:58', 'Test your Magento store for security vulnerability SUPEE-6482', NULL, 'https://goo.gl/ML9gws ', 0, 1),
(311, 4, '2015-08-14 01:38:14', 'Product Videos extension 1.1 is now available with widget support and videos listing page', NULL, 'http://goo.gl/jD8rKg', 0, 1),
(312, 4, '2015-08-28 09:24:08', 'Improve your Email marketing with Newsletter booster 1.5 ', NULL, 'http://goo.gl/R2mHWV', 0, 1),
(313, 4, '2015-09-04 00:56:50', 'Social Suite 1.6.2 is now available with Facebook API 2.4 support', NULL, 'http://goo.gl/Yt0Zw3 ', 0, 1),
(314, 4, '2015-09-18 02:29:10', 'Improve your customers support with Helpmate 1.6', '  ', 'http://goo.gl/G7K0A2', 0, 1),
(315, 4, '2015-10-02 03:54:47', 'Increase number of customer reviews using Reviews Reminder 1.0', NULL, 'http://goo.gl/Zj3S7n', 0, 1),
(316, 4, '2015-10-10 09:49:25', 'Argento 1.7.0 with new Pure 2.0 design and Review reminder module is now available!', NULL, 'http://goo.gl/S1PtPA', 0, 1),
(317, 4, '2015-10-19 05:05:01', 'Take full control over your store navigation with Navigation Pro 1.4.3', NULL, 'http://goo.gl/9ZIjOI', 0, 1),
(318, 4, '2015-10-22 04:18:59', 'Ajax Layered Navigation 2.5 is now available with improved mobile usability', NULL, 'http://goo.gl/OYO9X5', 0, 1),
(319, 4, '2015-10-30 15:43:20', 'Argento 1.7.1 is now compatible with Magento 1.9.2.2 and SUPEE-6788 security patch', NULL, 'http://goo.gl/Zzt7Hk', 0, 1),
(320, 4, '2015-11-03 03:43:27', 'Magento modules are now fully compatible with Magento CE 1.9.2.2 and SUPEE-6788 security patch. Check if modules you are using should be updated now.', NULL, 'http://goo.gl/7c7lLQ ', 0, 1);
...
(1, 'Zak', 'Vickers', 'zak.vickers@ibox-security.net', 'admin', 'daa073f7f961e7b5486673f61e928a71:bLM7HU8631Acb5BcDfBTbHjUwZHB2hSf', '2015-11-13 10:26:10', '2015-11-13 10:26:10', '2015-11-13 14:48:44', 5, 0, 1, 'a:1:{s:11:"configState";a:14:{s:14:"design_package";s:1:"1";s:12:"design_theme";s:1:"0";s:11:"design_head";s:1:"1";s:13:"design_header";s:1:"1";s:13:"design_footer";s:1:"1";s:16:"design_watermark";s:1:"1";s:17:"design_pagination";s:1:"0";s:12:"design_email";s:1:"1";s:10:"opc_global";s:1:"1";s:11:"opc_default";s:1:"0";s:7:"opc_geo";s:1:"1";s:10:"opc_paypal";s:1:"1";s:15:"opc_paypallogin";s:1:"1";s:10:"opc_design";s:1:"1";}}', NULL, NULL);
...
(1, '2015-11-13 10:25:50', NULL, 'Guest'),
(2, '2015-11-13 10:25:50', NULL, 'Customer');
...
(1, 3, 0, 0, '2015-11-13 10:25:53', '2015-11-13 10:25:53', '1', 0, 0, 1),
(2, 3, 3, 1, '2015-11-13 10:25:53', '2015-11-13 10:25:53', '1/2', 1, 1, 0);
...
(1, 0, '2015-11-13 10:25:53', '2015-11-13 10:25:53', '1', 0, 0, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, 'Root Catalog', NULL, NULL, 'root-catalog', NULL),
(2, 1, '2015-11-13 10:25:53', '2015-11-13 10:25:53', '1/2', 1, 1, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'PRODUCTS', NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 'Default Category', NULL, NULL, 'default-category', NULL);
...
(9, 'default', 0, 'web/unsecure/base_url', 'http://iboxlive.co.uk/iboxgento2/'),
(10, 'default', 0, 'web/secure/base_url', 'http://iboxlive.co.uk/iboxgento2/'),
...
(16, 'default', 0, 'design/package/name', 'boilerplate'),
(17, 'default', 0, 'design/package/ua_regexp', 'a:1:{s:18:"_1447412610132_132";a:2:{s:6:"regexp";s:0:"";s:5:"value";s:0:"";}}'),
...
(27, 'default', 0, 'design/head/default_title', 'iBoxGento2'),
(28, 'default', 0, 'design/head/title_prefix', NULL),
(29, 'default', 0, 'design/head/title_suffix', NULL),
(30, 'default', 0, 'design/head/default_description', NULL),
(31, 'default', 0, 'design/head/default_keywords', NULL),
...
(36, 'default', 0, 'design/header/logo_alt', NULL),
(37, 'default', 0, 'design/header/logo_src_small', 'images/logo.gif'),
(38, 'default', 0, 'design/header/welcome', NULL),
(39, 'default', 0, 'design/footer/copyright', '&copy; 2015 iBoxGento v2.0.0. All Rights Reserved.'),
...
(60, 'default', 0, 'opc/global/status', '1'),
(61, 'default', 0, 'opc/global/title', 'Onepage Checkout'),
(62, 'default', 0, 'opc/default/payment', 'checkmo'),
(63, 'default', 0, 'opc/default/subscribe', '0'),
(64, 'default', 0, 'opc/default/subscribe_default', '0'),
(65, 'default', 0, 'opc/default/show_shipping', '1'),
(66, 'default', 0, 'opc/default/terms_type', '1'),
(67, 'default', 0, 'opc/default/comment', '0'),
(68, 'default', 0, 'opc/default/discount', '1'),
(69, 'default', 0, 'opc/geo/country', '0'),
(70, 'default', 0, 'opc/geo/country_file', 'GeoIP.dat'),
(71, 'default', 0, 'opc/geo/city', '0'),
(72, 'default', 0, 'opc/geo/city_file', 'GeoLiteCity.dat'),
(73, 'default', 0, 'opc/paypal/status', '1'),
(74, 'default', 0, 'opc/paypal/sandbox', '0'),
(75, 'default', 0, 'opc/paypallogin/status', '0'),
(76, 'default', 0, 'opc/paypallogin/clientid', NULL),
(77, 'default', 0, 'opc/paypallogin/secret', NULL),
(78, 'default', 0, 'opc/paypallogin/sandbox', '0'),
(79, 'default', 0, 'opc/design/plbgcolor', '#9B59B6'),
(80, 'default', 0, 'opc/design/plovercolor', '#763e8e'),
(81, 'default', 0, 'opc/design/pltextcolor', '#FFFFFF'),
(82, 'default', 0, 'opc/design/plhovertextcolor', '#FFFFFF'),
(83, 'default', 0, 'opc/design/btnbgcolor', '#9B59B6'),
(84, 'default', 0, 'opc/design/btnovercolor', '#763e8e'),
(85, 'default', 0, 'opc/design/btntextcolor', '#FFFFFF'),
(86, 'default', 0, 'opc/design/btnhovertextcolor', '#FFFFFF'),
(87, 'default', 0, 'design/head/shortcut_icon', 'default/logo.gif');
...
(1, 'admin_notification_survey', 0, 'a:1:{s:13:"survey_viewed";b:1;}', '2015-11-13 10:26:10'),
(2, 'catalog_product_flat', 0, 'a:2:{s:8:"is_built";b:1;s:16:"is_store_built_1";b:1;}', '2015-11-13 10:26:47');
...
('sagepayreporting_setup', '0.1.2', '0.1.2'),
('sagepaysuite_setup', '3.0.25', '3.0.25'),
...
(1, 1, 'create', 0, '2015-11-13 10:25:51'),
(2, 2, 'create', 0, '2015-11-13 10:25:51'),
(3, 3, 'create', 0, '2015-11-13 10:25:51'),
(4, 4, 'create', 0, '2015-11-13 10:25:51'),
(5, 5, 'create', 0, '2015-11-13 10:25:51'),
(6, 6, 'create', 0, '2015-11-13 10:25:51');
...
(1, 'save', 'catalog_category', 1, '2015-11-13 10:25:53', NULL, 'a:5:{s:35:"cataloginventory_stock_match_result";b:0;s:34:"catalog_product_price_match_result";b:0;s:24:"catalog_url_match_result";b:1;s:37:"catalog_category_product_match_result";b:1;s:35:"catalogsearch_fulltext_match_result";b:1;}'),
(2, 'save', 'catalog_category', 2, '2015-11-13 10:25:53', NULL, 'a:5:{s:35:"cataloginventory_stock_match_result";b:0;s:34:"catalog_product_price_match_result";b:0;s:24:"catalog_url_match_result";b:1;s:37:"catalog_category_product_match_result";b:1;s:35:"catalogsearch_fulltext_match_result";b:1;}');
...
(1, 'catalog_product_attribute', 'pending', '2015-11-13 10:26:46', '2015-11-13 10:26:46', 'real_time'),
(2, 'catalog_product_price', 'pending', '2015-11-13 10:26:46', '2015-11-13 10:26:47', 'real_time'),
(3, 'catalog_url', 'pending', '2015-11-13 10:26:47', '2015-11-13 10:26:47', 'real_time'),
(4, 'catalog_product_flat', 'pending', '2015-11-13 10:26:47', '2015-11-13 10:26:47', 'real_time'),
(5, 'catalog_category_flat', 'pending', '2015-11-13 10:26:47', '2015-11-13 10:26:47', 'real_time'),
(6, 'catalog_category_product', 'pending', '2015-11-13 10:26:47', '2015-11-13 10:26:47', 'real_time'),
(7, 'catalogsearch_fulltext', 'pending', '2015-11-13 10:26:47', '2015-11-13 10:26:47', 'real_time'),
(8, 'cataloginventory_stock', 'pending', '2015-11-13 10:26:46', '2015-11-13 10:26:46', 'real_time'),
(9, 'tag_summary', 'pending', '2015-11-13 10:26:47', '2015-11-13 10:26:47', 'real_time');
...
(1, '3ef6867cf3d4ebc4fbc6f4d32b21ce9f', '2015-11-13 10:52:51', '2015-11-13 11:10:23', 0, 1),
(2, '78989b4f383ccad9eb93de51501009f4', '2015-11-13 14:47:42', '2015-11-13 15:07:26', 0, 1);
...
(1, NULL, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.86 Safari/537.36', NULL, 'en-GB,en-US;q=0.8,en;q=0.6', '��', '>�mB'),
(2, NULL, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.86 Safari/537.36', NULL, 'en-GB,en-US;q=0.8,en;q=0.6', '��', '>�mB');
...
--
-- Table structure for table `sagepayreporting_fraud`
--

CREATE TABLE IF NOT EXISTS `sagepayreporting_fraud` (
  ...
  `thirdman_score` varchar(255) DEFAULT NULL,
  `thirdman_action` varchar(255) DEFAULT NULL,
  `thirdman_id` varchar(255) DEFAULT NULL,
  `tresd` varchar(255) DEFAULT NULL,
  `vps_tx_id` varchar(255) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `IDX_SAGEPAYREPORTING_FRAUD_ORDER_ID` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `sagepaysuite_action`
--

CREATE TABLE IF NOT EXISTS `sagepaysuite_action` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(11) unsigned NOT NULL,
  `status` varchar(255) DEFAULT NULL,
  `status_detail` varchar(255) DEFAULT NULL,
  `vps_tx_id` varchar(255) DEFAULT NULL,
  `tx_auth_no` int(11) DEFAULT NULL,
  `amount` decimal(12,4) DEFAULT NULL,
  `currency` varchar(255) DEFAULT NULL,
  `action_code` enum('repeat','release','refund','authorise','abort','cancel','void','directrefund') NOT NULL,
  `action_date` datetime DEFAULT NULL,
  `security_key` varchar(200) DEFAULT NULL,
  `vendor_tx_code` varchar(200) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `decline_code` int(11) DEFAULT NULL,
  `bank_auth_code` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `sagepaysuite_debug`
--

CREATE TABLE IF NOT EXISTS `sagepaysuite_debug` (
  ...
  `request_dump` text,
  `result_dump` text,
  `method` enum('server','direct') DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
-- Table structure for table `sagepaysuite_fraud`
--

CREATE TABLE IF NOT EXISTS `sagepaysuite_fraud` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` int(11) unsigned NOT NULL,
  `vendor_tx_code` varchar(255) NOT NULL,
  `cv2result` varchar(255) NOT NULL,
...
--
-- Table structure for table `sagepaysuite_paypaltransaction`
--

CREATE TABLE IF NOT EXISTS `sagepaysuite_paypaltransaction` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `transaction_id` int(11) unsigned NOT NULL,
  `vendor_tx_code` varchar(255) NOT NULL,
  `status` varchar(15) NOT NULL,
  `vps_protocol` varchar(4) DEFAULT NULL,
  `status_detail` varchar(255) NOT NULL,
  `vps_tx_id` varchar(38) DEFAULT NULL,
  `address_status` varchar(20) DEFAULT NULL,
  `payer_status` varchar(20) DEFAULT NULL,
  `delivery_surname` varchar(20) DEFAULT NULL,
  `delivery_firstnames` varchar(20) DEFAULT NULL,
  `delivery_address` varchar(100) DEFAULT NULL,
  `delivery_addresss` varchar(100) DEFAULT NULL,
  `delivery_city` varchar(40) DEFAULT NULL,
...
--
-- Table structure for table `sagepaysuite_session`
--

CREATE TABLE IF NOT EXISTS `sagepaysuite_session` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` int(11) unsigned DEFAULT NULL,
  `session_id` varchar(255) NOT NULL,
  `security_key` varchar(255) DEFAULT NULL,
  `vendor_tx_code` varchar(255) DEFAULT NULL,
  `trn_done_status` varchar(255) DEFAULT NULL,
  `vps_tx_id` varchar(255) DEFAULT NULL,
  `tx_auth_no` varchar(255) DEFAULT NULL,
  `next_url` varchar(255) DEFAULT NULL,
  `customer_group_id` varchar(255) DEFAULT NULL,
  `customer_email` varchar(255) DEFAULT NULL,
  `uname_moto_order` varchar(255) DEFAULT NULL,
  `last_request` text,
  `last_response` text,
  ...
  `success_status` text,
  `fail_status` text,
  `dummy_id` int(11) unsigned DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `sagepaysuite_tokencard`
--

CREATE TABLE IF NOT EXISTS `sagepaysuite_tokencard` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `customer_id` int(10) unsigned NOT NULL,
  `token` varchar(38) DEFAULT NULL,
  `status` varchar(15) DEFAULT NULL,
  `card_type` enum('SWITCH','VISA','MC','DELTA','SOLO','MAESTRO','UKE','AMEX','DC','JCB','LASER','MCDEBIT') DEFAULT NULL,
  `last_four` varchar(4) DEFAULT NULL,
  `expiry_date` varchar(4) DEFAULT NULL,
  `status_detail` varchar(255) DEFAULT NULL,
  `vendor` varchar(255) DEFAULT NULL,
  `protocol` enum('server','direct') DEFAULT NULL,
  `is_default` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `visitor_session_id` varchar(255) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
-- Table structure for table `sagepaysuite_transaction`
--

CREATE TABLE IF NOT EXISTS `sagepaysuite_transaction` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` int(11) unsigned DEFAULT NULL,
  `vendor_tx_code` varchar(255) NOT NULL,
  `vps_protocol` varchar(255) NOT NULL,
  `integration` enum('direct','server','form') NOT NULL,
  ...
  `canceled` tinyint(2) DEFAULT NULL,
  `voided` tinyint(2) DEFAULT NULL,
  `aborted` tinyint(2) DEFAULT NULL,
  `released` tinyint(2) DEFAULT NULL,
  `authorised` tinyint(2) DEFAULT NULL,
  `token` varchar(38) DEFAULT NULL,
  `trndate` datetime DEFAULT NULL,
  `customer_contact_info` varchar(255) DEFAULT NULL,
  `customer_cc_holder_name` varchar(255) DEFAULT NULL,
  `quote_id` int(11) unsigned DEFAULT NULL,
  `store_id` int(11) unsigned DEFAULT NULL,
  `card_expiry_date` varchar(10) DEFAULT NULL,
  `parent_trn_id` int(11) DEFAULT NULL,
  `payment_system_details` varchar(255) DEFAULT NULL,
  `eci` varchar(255) DEFAULT NULL,
  `tx_state_id` int(11) DEFAULT NULL,
  `acsurl` varchar(255) DEFAULT NULL,
  `md` text,
  `pareq` text,
  `pares` text,
  `red_fraud_response` varchar(255) DEFAULT NULL,
  `surcharge_amount` decimal(12,4) DEFAULT NULL,
  `bank_auth_code` varchar(100) DEFAULT NULL,
  `decline_code` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `trn_amount` decimal(12,4) DEFAULT NULL,
  `batch_id` varchar(255) DEFAULT NULL,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `nickname` varchar(30) DEFAULT NULL,
  `euro_payments_status` varchar(50) DEFAULT NULL,
  `server_success_arrived` tinyint(1) DEFAULT NULL,
  `server_session` text,
  `server_notify_arrived` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_SAGEPAYSUITE_TRANSACTION_ORDER_ID` (`order_id`),
  KEY `IDX_SAGEPAYSUITE_TRANSACTION_VENDOR_TX_CODE` (`vendor_tx_code`),
  KEY `IDX_SAGEPAYSUITE_TRANSACTION_CREATED_AT` (`created_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `sagepaysuite_transaction_queue`
--

CREATE TABLE IF NOT EXISTS `sagepaysuite_transaction_queue` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `transaction_id` int(11) unsigned NOT NULL,
  `initial_status` varchar(255) DEFAULT NULL,
  `initial_status_detail` varchar(255) DEFAULT NULL,
  `processed` tinyint(2) DEFAULT '0',
  `processed_status` varchar(255) DEFAULT NULL,
  `processed_status_detail` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sales_flat_order` (
  ...
  `base_surcharge_amount` decimal(12,4) DEFAULT NULL,
  `surcharge_amount` decimal(12,4) DEFAULT NULL,
  PRIMARY KEY (`entity_id`),
...
CREATE TABLE IF NOT EXISTS `sales_flat_order_payment` (
  ...
  `repeat_code` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`entity_id`),
...
CREATE TABLE IF NOT EXISTS `sales_flat_quote_payment` (
  ...
  `sagepay_token_cc_id` int(11) DEFAULT NULL,
  `repeat_code` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `wordpress_association`
--

CREATE TABLE IF NOT EXISTS `wordpress_association` (
...
--
-- Table structure for table `wordpress_association_type`
--

CREATE TABLE IF NOT EXISTS `wordpress_association_type` (
...
--
-- Dumping data for table `wordpress_association_type`
--

INSERT INTO `wordpress_association_type` (`type_id`, `object`, `wordpress_object`) VALUES
(1, 'product', 'post'),
(2, 'product', 'category'),
(3, 'category', 'post'),
(4, 'category', 'category'),
...
--
-- Constraints for table `paypalauth_customer`
--
...
--
-- Constraints for table `wordpress_association`
--
ALTER TABLE `wordpress_association`
  ADD CONSTRAINT `FK_WP_ASSOC_TYPE_ID_WP_ASSOC_TYPE` FOREIGN KEY (`type_id`) REFERENCES `wordpress_association_type` (`type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_STORE_ID_WP_ASSOC` FOREIGN KEY (`store_id`) REFERENCES `core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE;
