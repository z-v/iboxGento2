...
{
	/**
	 * Cache for parent terms
	 *
	 * @var array
	 */
	protected $_parentTermCache = array();
	...
	public function getParentTermsByPostId($postId, $taxonomy = 'category')
	{
		...
		if (isset($this->_parentTermCache[$cacheKey])) {
			return $this->_parentTermCache[$cacheKey];
		}
		...
		return $this->_parentTermCache[$cacheKey] = $this->_getReadAdapter()->fetchAll($select);
		...
		return $this->_parentTermCache[$cacheKey] = $this->_getReadAdapter()->fetchAll($wrapper);
	}
